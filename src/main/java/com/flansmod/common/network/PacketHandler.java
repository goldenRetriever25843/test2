...
public class PacketHandler extends MessageToMessageCodec<FMLProxyPacket, PacketBase>
{
	...
	public void initialise()
	{
		...
		registerPacket(PacketBlood.class);
		registerPacket(PacketChecker.class);
		registerPacket(PacketVaccine.class);
	}
	...
	//gold sloth magic donut to allow long range only sounds
