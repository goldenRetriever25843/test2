...
public class BulletType extends ShootableType
{
	...
	public float seekerRange = 25843;
	public float nonpenPenalty = 0;
	public float barelypenPenalty = 0.25f;
	...
	//papa g grass and leaf killer
	public boolean papaDrill = false;
	...
	protected void read(String[] split, TypeFile file)
	{
		...
		try
		{
			...
			//for papa g grass drill
			else if(split[0].equals("papaDrill"))
				papaDrill = Boolean.parseBoolean(split[1]);
