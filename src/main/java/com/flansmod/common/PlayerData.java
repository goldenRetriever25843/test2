...
public class PlayerData 
{
	...
	public int shootTimeRight, shootTimeLeft, stabTimeLeft, stabTimeRight, isBlockingLeft, isBlockingRight, isBlockingTop, isBlockingBottom, minigunSpeed, nintendoSwitch, drawTime, s0, s1, s2, s3, s4, s5, s6, s7, s8, s9;
