...
public class TeamsManager
{
	...
	public static boolean voting = false, explosions = true, driveablesBreakBlocks = true, raiding = true, violence = false, bleeding = false,
	...
	private void loadPerWorldData(Event event, World world)
	{
		...
		try
		{
			...
			//for classic explosions
			raiding = tags.getBoolean("Raiding");
			//to stop retards from fighting before i say its filming time
			violence = tags.getBoolean("Violence");
			...
			seaLevel = tags.getInteger("SeaLevel");
	...
	private void savePerWorldData(Event event, World world)
	{
		...
		try
		{
			...
			//for raiding classic explosions
			tags.setBoolean("Raiding", raiding);
			//to stop retards from fighting before i say im filming
			tags.setBoolean("Violence", violence);
			...
			tags.setFloat("SeaLevel", seaLevel);
