...
public class KeyInputHandler
{
	...
	public static KeyBinding gunKey = new KeyBinding("Docking Key", Keyboard.KEY_B, "Flan's Mod");
    ...
    public static KeyBinding modeKey = new KeyBinding("Dive Key / VTOL", Keyboard.KEY_V, "Flan's Mod");
	...
	public static KeyBinding eject = new KeyBinding("Kickout Passengers", Keyboard.KEY_O, "Flan's Mod");
	public static KeyBinding openBorders = new KeyBinding("Allow Passengers", Keyboard.KEY_P, "Flan's Mod");
