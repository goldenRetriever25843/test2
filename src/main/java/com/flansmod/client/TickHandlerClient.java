	    ...
	    if(!event.isCancelable() && event.type == ElementType.HOTBAR && FlansMod.bulletGuiEnable)
	    {
			...
			if(mc.thePlayer != null)
			{
				...
				//bleeding system TM labjac
						...
						if(cringeBlood<100)
						mc.fontRenderer.drawString("Blood: " + cringeBlood  , 122, 30, 0xdaa520);	
						if(cringeHemorrhaging>0)
							mc.fontRenderer.drawString("FATAL BEEDING"  , 122, 42, 0xff0000);
...
//			}
			...
			if(mc.thePlayer.ridingEntity instanceof EntitySeat)
			{
				...
				float cringedUniversalBuff = 1.3f;
				float Mach = 0f;
				//labjac cringe fake mach number gauge
		if(Math.sqrt(speed)>1 && Math.sqrt(speed)<= 1.08)
				Mach = 0.1f;
		else if(Math.sqrt(speed)>1.08*cringedUniversalBuff && Math.sqrt(speed)<= 1.12*cringedUniversalBuff)
			Mach = 0.2f;
		else if(Math.sqrt(speed)>1.12*cringedUniversalBuff && Math.sqrt(speed)<= 1.2*cringedUniversalBuff)
			Mach = 0.3f;
		else if(Math.sqrt(speed)>1.2*cringedUniversalBuff && Math.sqrt(speed)<= 1.25*cringedUniversalBuff)
			Mach = 0.4f;
		else if(Math.sqrt(speed)>1.25*cringedUniversalBuff && Math.sqrt(speed)<= 1.3*cringedUniversalBuff)
			Mach = 0.5f;		
		else if(Math.sqrt(speed)>1.3*cringedUniversalBuff && Math.sqrt(speed)<= 1.4*cringedUniversalBuff)
			Mach = 0.6f;		
		else if(Math.sqrt(speed)>1.3*cringedUniversalBuff && Math.sqrt(speed)<= 1.42*cringedUniversalBuff)
			Mach = 0.7f;		
		else if(Math.sqrt(speed)>1.42*cringedUniversalBuff && Math.sqrt(speed)<= 1.45*cringedUniversalBuff)
			Mach = 0.75f;		
		else if(Math.sqrt(speed)>1.45*cringedUniversalBuff && Math.sqrt(speed)<= 1.49*cringedUniversalBuff)
			Mach = 0.8f;		
		else if(Math.sqrt(speed)>1.49*cringedUniversalBuff && Math.sqrt(speed)<= 1.52*cringedUniversalBuff)
			Mach = 0.85f;		
		else if(Math.sqrt(speed)>1.52*cringedUniversalBuff && Math.sqrt(speed)<= 1.56*cringedUniversalBuff)
			Mach = 0.9f;		
		else if(Math.sqrt(speed)>1.56*cringedUniversalBuff && Math.sqrt(speed)<= 1.6*cringedUniversalBuff)
			Mach = 0.95f;		
		else if(Math.sqrt(speed)>1.6*cringedUniversalBuff && Math.sqrt(speed)<= 1.7*cringedUniversalBuff)
			Mach = 1f;
		else if(Math.sqrt(speed)>1.7*cringedUniversalBuff && Math.sqrt(speed)<= 1.9*cringedUniversalBuff)
			Mach = 1.25f;
		else if(Math.sqrt(speed)>1.9*cringedUniversalBuff && Math.sqrt(speed)<= 2.2*cringedUniversalBuff)
			Mach = 1.5f;
		else if(Math.sqrt(speed)>2.2*cringedUniversalBuff && Math.sqrt(speed)<= 2.45*cringedUniversalBuff)
			Mach = 1.75f;
		else if(Math.sqrt(speed)>2.45*cringedUniversalBuff && Math.sqrt(speed)<= 2.75*cringedUniversalBuff)
			Mach = 2f;
		else if(Math.sqrt(speed)>2.75*cringedUniversalBuff && Math.sqrt(speed)<= 3.3*cringedUniversalBuff)
			Mach = 2.25f;
		else if(Math.sqrt(speed)>3.3*cringedUniversalBuff && Math.sqrt(speed)<= 3.6*cringedUniversalBuff)
			Mach = 2.5f;
		else if(Math.sqrt(speed)>3.6*cringedUniversalBuff && Math.sqrt(speed)<= 4.0*cringedUniversalBuff)
			Mach = 2.75f;
		else if(Math.sqrt(speed)>4.0*cringedUniversalBuff && Math.sqrt(speed)<= 4.5*cringedUniversalBuff)
			Mach = 3f;
		else if(Math.sqrt(speed)>4.5*cringedUniversalBuff && Math.sqrt(speed)<= 5.1*cringedUniversalBuff)
			Mach = 3.25f;
		else if(Math.sqrt(speed)>5.1*cringedUniversalBuff && Math.sqrt(speed)<= 5.85*cringedUniversalBuff)
			Mach = 3.5f;
		else if(Math.sqrt(speed)>5.85*cringedUniversalBuff && Math.sqrt(speed)<= 6.6*cringedUniversalBuff)
			Mach = 3.75f;
		else if(Math.sqrt(speed)>6.6*cringedUniversalBuff && Math.sqrt(speed)<= 7.4*cringedUniversalBuff)
			Mach = 4f;
		else if(Math.sqrt(speed)>7.4*cringedUniversalBuff && Math.sqrt(speed)<= 8*cringedUniversalBuff)
			Mach = 4.25f;
		else
			Mach = 0;
		//end of mach number cringe
				...
				{
					//if vehicle has afterburner, make 50% throttle look like 100% throttle
					if(ent.getDriveableType().hasAfterBurner && ent.throttle<=0.501)
						fakeThrottle =  (ent.throttle*2);
					else if(ent.getDriveableType().hasAfterBurner && ent.throttle>0.501)
						fakeThrottle = 1;
					else
						fakeThrottle = ent.throttle		;			
				}
				
				//while afterburning, throttle will change color epic style
				int colourThrottle = 0;
				if(ent.throttle < 0.5 && ent.getDriveableType().hasAfterBurner){
					colourThrottle = 0xffffff;
				} else if (ent.throttle < 0.7 && ent.throttle > 0.5 && ent.getDriveableType().hasAfterBurner){
					colourThrottle = 0x00ff00;
				} else if (ent.throttle < 0.9 && ent.throttle > 0.7 && ent.getDriveableType().hasAfterBurner){
					colourThrottle = 0xdaa520;
				} else if (ent.throttle > 0.9 && ent.getDriveableType().hasAfterBurner){
...
//				mc.fontRenderer.drawString("Throttle : " + ent.throttle, 2, 2, 0xffffff);
				...
				if(Mach>0)
				mc.fontRenderer.drawString("Mach " + Mach, 2, 22, 0xffffff);
			//debug speed 	mc.fontRenderer.drawString("Speed " + Math.sqrt(speed), 2, 32, 0xffffff);
				...
				if(ent.epicShip)
				{
					...
					int notFlooding = 100 * (int)((EntityVehicle)ent).getDriveableData().notFlooding / (int)((EntityVehicle)ent).getDriveableData().notFloodingMax;
					int color = 0;
					if(notFlooding > 75){
						color = 0xffffff;
					...
					mc.fontRenderer.drawString("Crew : " + ((EntityVehicle)ent).getDriveableData().totalCrew + " out of " + ((EntityVehicle)ent).getDriveableData().maximumCrew , 2, 12, 0xffffff);
					if(notFlooding==100)
				...
				if(!(ent instanceof EntityPlane))
				{
					...
					{
				mc.fontRenderer.drawString(String.format("Gun Pitch : %.0f%%", ((EntitySeat)mc.thePlayer.ridingEntity).looking.getPitch() * (-1f)), 122, 12, 0xffffff);
				mc.fontRenderer.drawString(String.format("Yaw : %.0f%%", ((EntitySeat)mc.thePlayer.ridingEntity).looking.getYaw()), 122, 2, 0xffffff);
					}
				...
				if(ent.getDriveableType().gunRange || ((EntitySeat)mc.thePlayer.ridingEntity).calculator)
				{
				...
				if (pitch > 0)
				mc.fontRenderer.drawString(String.format("Estimated Gun Range : %.0f",  displayRange), 122, 22, 0xffffff);
				if (displayRange > 350)
				mc.fontRenderer.drawString(String.format("Warning: Bullet May Freeze Outside of Render Range"), 122, 42, 0xff0000);
				...
				if( pitch>55f)
				mc.fontRenderer.drawString(String.format("Warning: Predicion Less Accurate at These Angles"), 122, 32, 0xdaa520);
				...
				if(ent instanceof EntityPlane)
				{
					...
					mc.fontRenderer.drawString(String.format("Plane Pitch : %.1f",  -1f*(float)entP.axes.getPitch()) + "°", 122, 22, 0xffffff);
					mc.fontRenderer.drawString(String.format("Plane Roll : %.1f", + -1f*(float)entP.axes.getRoll()) + "°", 122, 12, 0xffffff);
					if ((float)entP.axes.getYaw() < 22.5 && (float)entP.axes.getYaw() >= -22.5)
					mc.fontRenderer.drawString("Compass: East"  , 122, 2, 0xffffff);
					
					if ((float)entP.axes.getYaw() < 67.5 && (float)entP.axes.getYaw() >= 22.5)
					mc.fontRenderer.drawString("Compass: South East"  , 122, 2, 0xffffff);
					
					if ((float)entP.axes.getYaw() >= 67.5 && (float)entP.axes.getYaw() < 112.5)
					mc.fontRenderer.drawString("Compass: South"  , 122, 2, 0xffffff);
					
					if ((float)entP.axes.getYaw() >= 112.5 && (float)entP.axes.getYaw() < 157.5)
					mc.fontRenderer.drawString("Compass: South West"  , 122, 2, 0xffffff);
					
					if ((float)entP.axes.getYaw() < -157.5 || (float)entP.axes.getYaw() >= 157.5)
						mc.fontRenderer.drawString("Compass: West"  , 122, 2, 0xffffff);
					
					if ((float)entP.axes.getYaw() < -112.5 && (float)entP.axes.getYaw() >= -157.5)
						mc.fontRenderer.drawString("Compass: North West"  , 122, 2, 0xffffff);
					
					if ((float)entP.axes.getYaw() > -112.5 && (float)entP.axes.getYaw() <= -67.5)
					mc.fontRenderer.drawString("Compass: North"  , 122, 2, 0xffffff);
					
					if ((float)entP.axes.getYaw() > -67.5 && (float)entP.axes.getYaw() <= -22.5)
					mc.fontRenderer.drawString("Compass: North East"  , 122, 2, 0xffffff);

					//mc.fontRenderer.drawString(String.format("Altitude : %.0f%" + ((EntitySeat)mc.thePlayer.ridingEntity).posY), 122, 32, 0xffffff);
					mc.fontRenderer.drawString(String.format("Altitude : %.0f" , ((EntitySeat)mc.thePlayer.ridingEntity).posY) + " Meters", 122, 32, 0xffffff);
					
					if (entP.getDriveableType().rocketThrottle)
					mc.fontRenderer.drawString("Fuel : "+   entP.fuelTimer, 122, 42, 0xffffff);
					
					if (entP.getDriveableType().labjacFuel>10)
					mc.fontRenderer.drawString(String.format("Fuel : %.2f",   (float)entP.labjacFuel/12000) + " Minutes" , 122, 42, 0xffffff);
	//debug energy mc.fontRenderer.drawString(String.format("Energy : " + (float)entP.energy), 122, 72, 0xffffff);
					if (entP.carrierTip)
					mc.fontRenderer.drawString("Press "+ Keyboard.getKeyName(KeyInputHandler.gunKey.getKeyCode())+ " to dock", 122, 52, 0x00ff00);
					if (entP.mounted)
					mc.fontRenderer.drawString("Press "+ Keyboard.getKeyName(KeyInputHandler.bombKey.getKeyCode())+ " to undock", 122, 52, 0xff0000);
				...
				if(ent instanceof EntityVehicle)
				{
					...
					{
						if(entP.ticksFlareUsing <= 0 && entP.flareDelay <= 0)
							mc.fontRenderer.drawString("Smoke : READY"  , 2, 52, 0x00ff00);
					...
					if(entP.getDriveableType().hasFlare && entP.getDriveableType().epicShip)
					{
						...
						{
							mc.fontRenderer.drawString("You must be at"  , 2, 42, 0xdaa520);
					...
					{
						if(entP.APSdelay <= 5)
							mc.fontRenderer.drawString("APS : READY"  , 2, 42, 0x00ff00);
					...
					//end scopes
						if(((EntityVehicle)ent).getVehicleType().airship)
							mc.fontRenderer.drawString(String.format("Diving Throttle : %.0f%%", ent.divingFactor*100), 2, 32, 0xffffff);
					...
					if(((EntityVehicle)ent).getVehicleType().canDive)
					{
						...
						mc.fontRenderer.drawString(String.format("Diving Throttle : %.0f%%", ent.divingFactor*100), 2, 52, 0xffffff);

						if(((EntityVehicle)entP).getVehicleType().unlimitedOxygen==false)
						mc.fontRenderer.drawString("Oxygen (Seconds) : " + ent.oxygenMeter/160f  , 2, 62, colour);
						if(((EntityVehicle)entP).getVehicleType().unlimitedOxygen==true)
						mc.fontRenderer.drawString("Unlimited Oxygen", 2, 62, colour);
						...
						if(poopooDepth>0)
						{
							...
							if(poopooDepth / (float)allah.maxDepth > 0.7)
								mc.fontRenderer.drawString("WARNING : Aproaching Max Depth"  , 2, 82, 0xdaa520);
		
							if(poopooDepth / (float)allah.maxDepth > 0.9)
								mc.fontRenderer.drawString("DANGER : COLLAPSE IMMINENT"  , 2, 92, 0xff0000);
						}
