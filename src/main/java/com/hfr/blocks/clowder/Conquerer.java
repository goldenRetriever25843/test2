	...
	public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase player, ItemStack itemStack) {
		...
		if(player instanceof EntityPlayer && !world.isRemote) {
			...
			if(clowder != null && flag.checkBorder(x, z) && flag.canSeeSky() && noProximity(world, x, y, z)) 
			{
				...
				//if you are at war with terrain owner, or you are victim and in attacker terrain, success!!! PRAISE ALLAH
				if (   (owner.owner != null && clowder.enemy == owner.owner && clowder.getWartime() > 0)  ||   (owner.owner != null && owner.owner.enemy == clowder && owner.owner.getWartime() > 0)   )
				{
