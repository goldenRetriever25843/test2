...
public class CraftingManager {
	...
	public static void AddCraftingRec()
	{
		...
		GameRegistry.addRecipe(new ItemStack(ModBlocks.machine_sawmill, 1), new Object[] { "MSM", "BFB", "WWW", 'M', ModItems.components_mechanical, 'S', ModItems.ingot_tap_steel, 'B', ModItems.part_sawblade, 'F', ModItems.components_scaffold, 'W', ModItems.components_wood });
		...
		GameRegistry.addRecipe(new ItemStack(ModItems.components_plating), new Object[] { "GSG", "SBS", "GSG", 'G', Items.gold_nugget, 'S', ModItems.ingot_tap_steel, 'B', ModItems.ingot_boron });
