...
public class PlayerHitbox 
{
	...
	public float hitByBullet(EntityBullet bullet, float penetratingPower) 
	{
		...
		{
		case BODY : break;
		case HEAD : damageModifier *= 1.5F; break;
		case HEART : damageModifier *= 3F; break;
		case BRAIN : damageModifier *= 3F; break;
		...
		switch(type)
		{
		case BODY :  case BRAIN :  case HEAD :  case HEART :  case LEFTARM :  case RIGHTARM : 
		{
