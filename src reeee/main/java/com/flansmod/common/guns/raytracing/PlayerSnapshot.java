...
public class PlayerSnapshot 
{
	...
	public PlayerSnapshot(EntityPlayer p)
	{
		...
		hitboxes.add(new PlayerHitbox(player, bodyAxes, new Vector3f(0F, 0F, 0F), new Vector3f(-0.05F, 1.2F, -0.2F), new Vector3f(0.1F, 0.1F, 0.4F), EnumHitboxType.HEART));	
		hitboxes.add(new PlayerHitbox(player, bodyAxes.findLocalAxesGlobally(headAxes), new Vector3f(0.0F, 1.4F, 0F), new Vector3f(-0.25F, 0F, -0.25F), new Vector3f(0.5F, 0.25F, 0.5F), EnumHitboxType.HEAD));
		hitboxes.add(new PlayerHitbox(player, bodyAxes.findLocalAxesGlobally(headAxes), new Vector3f(0.0F, 1.4F, 0F), new Vector3f(-0.25F, 0.25F, -0.25F), new Vector3f(0.5F, 0.25F, 0.5F), EnumHitboxType.BRAIN));
