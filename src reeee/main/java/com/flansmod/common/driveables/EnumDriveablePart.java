...
public enum EnumDriveablePart 
{
	...
	//LabJac parts
	composite(new EnumDriveablePart[] { }, "composite", "Composite Armor Layer"),
	composite2(new EnumDriveablePart[] { }, "composite2", "Additional Composite Armor Layer"),
	spaced(new EnumDriveablePart[] { }, "spaced", "Spaced Armor"),
	compositeL(new EnumDriveablePart[] { }, "compositeL", "Left Composite Armor Layer"),
	compositeR(new EnumDriveablePart[] { }, "compositeR", "Right Composite Armor Layer"),
	...
	moreturretarmor(new EnumDriveablePart[] { }, "moreturretarmor", "Turret Composite Armor"),
