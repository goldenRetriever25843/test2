...
public class GametypeZombies extends Gametype 
{
	...
	public void tick() 
	{
		...
		{
			teamsManager.messageAll("\u00a7cThe \u00a74enemies \u00a7care upon us! 10 seconds until they \u00a74attack\u00a7c!");
		}
		
		//Human prep time over
		if(teamsManager.roundTimeLeft + humanPrepTime == teamsManager.currentRound.timeLimit * 20 * 60)
		{
			teamsManager.messageAll("\u00a7cThe \u00a74enemy \u00a7cis here!");
	...
	public void zombifySomeone()
	{
		if(teamsManager.currentRound.teams[0].members.size() > 0)
		{
			...
			teamsManager.messageAll("\u00a74" + zombifiedPlayer.getCommandSenderName() + "\u00a7c was actually part of the \u00a74enemy team\u00a7c!");
