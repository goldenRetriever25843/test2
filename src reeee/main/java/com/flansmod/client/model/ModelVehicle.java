...
public class ModelVehicle extends ModelDriveable
{
	...
	public ModelRendererTurbo infantryModel[] = new ModelRendererTurbo[0];
	...
	public void render(float f5, EntityVehicle vehicle, float f)
    {
        ...
        if(vehicle.isPartIntact(EnumDriveablePart.infantry))
        {
			for (ModelRendererTurbo aInfantryModel : infantryModel) {
				aInfantryModel.render(f5, oldRotateOrder);
			}
        }
        //Render guns
