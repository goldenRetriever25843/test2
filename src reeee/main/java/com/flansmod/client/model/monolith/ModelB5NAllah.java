...
public class ModelB5NAllah extends ModelPlane
{
	int textureX = 512;
	int textureY = 512;

	public ModelB5NAllah()
	{
		...
		bodyModel[16] = new ModelRendererTurbo(this, 489, 121, textureX, textureY); // Box 0
		bodyModel[17] = new ModelRendererTurbo(this, 489, 121, textureX, textureY); // Box 0
		bodyModel[18] = new ModelRendererTurbo(this, 225, 25, textureX, textureY); // Box 0
		bodyModel[19] = new ModelRendererTurbo(this, 33, 1, textureX, textureY); // Box 0
		bodyModel[20] = new ModelRendererTurbo(this, 225, 25, textureX, textureY); // Box 0
		bodyModel[21] = new ModelRendererTurbo(this, 233, 25, textureX, textureY); // Box 0
		bodyModel[22] = new ModelRendererTurbo(this, 489, 121, textureX, textureY); // Box 0
		bodyModel[23] = new ModelRendererTurbo(this, 401, 25, textureX, textureY); // Box 0
		bodyModel[24] = new ModelRendererTurbo(this, 401, 25, textureX, textureY); // Box 0
		bodyModel[25] = new ModelRendererTurbo(this, 489, 121, textureX, textureY); // Box 0
		...
		bodyModel[38] = new ModelRendererTurbo(this, 489, 129, textureX, textureY); // Box 0
		...
		bodyModel[41] = new ModelRendererTurbo(this, 489, 145, textureX, textureY); // Box 0
		bodyModel[42] = new ModelRendererTurbo(this, 489, 121, textureX, textureY); // Box 0
		bodyModel[43] = new ModelRendererTurbo(this, 489, 121, textureX, textureY); // Box 0
		bodyModel[44] = new ModelRendererTurbo(this, 401, 145, textureX, textureY); // Box 0
		bodyModel[45] = new ModelRendererTurbo(this, 209, 1, textureX, textureY); // Box 0
		bodyModel[46] = new ModelRendererTurbo(this, 193, 1, textureX, textureY); // Box 0
		bodyModel[47] = new ModelRendererTurbo(this, 465, 177, textureX, textureY); // Box 0
		bodyModel[48] = new ModelRendererTurbo(this, 129, 49, textureX, textureY); // Box 90
		bodyModel[49] = new ModelRendererTurbo(this, 1, 185, textureX, textureY); // Box 91
		bodyModel[50] = new ModelRendererTurbo(this, 161, 49, textureX, textureY); // Box 0
		bodyModel[51] = new ModelRendererTurbo(this, 281, 193, textureX, textureY); // Box 0
		bodyModel[52] = new ModelRendererTurbo(this, 225, 1, textureX, textureY); // Box 0
		bodyModel[53] = new ModelRendererTurbo(this, 241, 1, textureX, textureY); // Box 0
		bodyModel[54] = new ModelRendererTurbo(this, 257, 1, textureX, textureY); // Box 0
		bodyModel[55] = new ModelRendererTurbo(this, 273, 1, textureX, textureY); // Box 0
		bodyModel[56] = new ModelRendererTurbo(this, 305, 1, textureX, textureY); // Box 0
		bodyModel[57] = new ModelRendererTurbo(this, 81, 185, textureX, textureY); // Box 0
		bodyModel[58] = new ModelRendererTurbo(this, 129, 49, textureX, textureY); // Box 0
		bodyModel[59] = new ModelRendererTurbo(this, 97, 201, textureX, textureY); // Box 0
		bodyModel[60] = new ModelRendererTurbo(this, 281, 201, textureX, textureY); // Box 0
		bodyModel[61] = new ModelRendererTurbo(this, 201, 201, textureX, textureY); // Box 0
		bodyModel[62] = new ModelRendererTurbo(this, 345, 201, textureX, textureY); // Box 0
		bodyModel[63] = new ModelRendererTurbo(this, 505, 129, textureX, textureY); // Box 0
		bodyModel[64] = new ModelRendererTurbo(this, 361, 1, textureX, textureY); // Box 0
		bodyModel[65] = new ModelRendererTurbo(this, 417, 1, textureX, textureY); // Box 0
		bodyModel[66] = new ModelRendererTurbo(this, 473, 145, textureX, textureY); // Box 0
		bodyModel[67] = new ModelRendererTurbo(this, 1, 209, textureX, textureY); // Box 0
		bodyModel[68] = new ModelRendererTurbo(this, 1, 161, textureX, textureY); // Box 0
		bodyModel[69] = new ModelRendererTurbo(this, 385, 217, textureX, textureY); // Box 0
		...
		bodyModel[16].addBox(-0.5F, -0.5F, -0.5F, 1, 8, 1, 0F); // Box 0
		bodyModel[16].setRotationPoint(-43F, -35.5F, 4F);
		bodyModel[16].rotateAngleX = 0.34906585F;

		bodyModel[17].addBox(-0.5F, -0.5F, -0.5F, 1, 8, 1, 0F); // Box 0
		bodyModel[17].setRotationPoint(-43F, -35.5F, -4F);
		bodyModel[17].rotateAngleX = -0.34906585F;

		bodyModel[18].addBox(-0.5F, -0.5F, -0.5F, 1, 5, 1, 0F); // Box 0
		bodyModel[18].setRotationPoint(-43F, -37.5F, 0F);
		bodyModel[18].rotateAngleX = 1.13446401F;

		bodyModel[19].addBox(-0.5F, -0.5F, -0.5F, 1, 5, 1, 0F); // Box 0
		bodyModel[19].setRotationPoint(-43F, -37.5F, 0F);
		bodyModel[19].rotateAngleX = -1.13446401F;

		bodyModel[20].addBox(-0.5F, -0.5F, -0.5F, 1, 9, 1, 0F); // Box 0
		bodyModel[20].setRotationPoint(-43F, -35.5F, 4F);
		bodyModel[20].rotateAngleX = 0.85521133F;
		bodyModel[20].rotateAngleY = 1.57079633F;

		bodyModel[21].addBox(-0.5F, -0.5F, -0.5F, 1, 9, 1, 0F); // Box 0
		bodyModel[21].setRotationPoint(-43F, -35.5F, -4F);
		bodyModel[21].rotateAngleX = 0.85521133F;
		bodyModel[21].rotateAngleY = 1.57079633F;

		bodyModel[22].addBox(-0.5F, -0.5F, -0.5F, 1, 8, 1, 0F); // Box 0
		bodyModel[22].setRotationPoint(-33F, -35.3F, 4F);
		bodyModel[22].rotateAngleX = 0.33161256F;

		bodyModel[23].addBox(-0.5F, -0.5F, -0.5F, 1, 5, 1, 0F); // Box 0
		bodyModel[23].setRotationPoint(-33F, -37.3F, 0F);
		bodyModel[23].rotateAngleX = 1.13446401F;

		bodyModel[24].addBox(-0.5F, -0.5F, -0.5F, 1, 5, 1, 0F); // Box 0
		bodyModel[24].setRotationPoint(-33F, -37.3F, 0F);
		bodyModel[24].rotateAngleX = -1.13446401F;

		bodyModel[25].addBox(-0.5F, -0.5F, -0.5F, 1, 8, 1, 0F); // Box 0
		bodyModel[25].setRotationPoint(-33F, -35.3F, -4F);
		bodyModel[25].rotateAngleX = -0.33161256F;

		bodyModel[26].addBox(-0.5F, -0.5F, -0.5F, 1, 8, 1, 0F); // Box 0
		bodyModel[26].setRotationPoint(-24F, -35.1F, 4F);
		bodyModel[26].rotateAngleX = 0.31415927F;

		bodyModel[27].addBox(-0.5F, -0.5F, -0.5F, 1, 5, 1, 0F); // Box 0
		bodyModel[27].setRotationPoint(-24F, -37.1F, 0F);
		bodyModel[27].rotateAngleX = 1.13446401F;

		bodyModel[28].addBox(-0.5F, -0.5F, -0.5F, 1, 5, 1, 0F); // Box 0
		bodyModel[28].setRotationPoint(-24F, -37.1F, 0F);
		bodyModel[28].rotateAngleX = -1.13446401F;

		bodyModel[29].addBox(-0.5F, -0.5F, -0.5F, 1, 8, 1, 0F); // Box 0
		bodyModel[29].setRotationPoint(-24F, -35.1F, -4F);
		bodyModel[29].rotateAngleX = -0.31415927F;

		bodyModel[30].addBox(-0.5F, -0.5F, -0.5F, 1, 8, 1, 0F); // Box 0
		bodyModel[30].setRotationPoint(-15F, -34.9F, 4F);
		bodyModel[30].rotateAngleX = 0.29670597F;

		bodyModel[31].addBox(-0.5F, -0.5F, -0.5F, 1, 5, 1, 0F); // Box 0
		bodyModel[31].setRotationPoint(-15F, -36.9F, 0F);
		bodyModel[31].rotateAngleX = 1.13446401F;

		bodyModel[32].addBox(-0.5F, -0.5F, -0.5F, 1, 5, 1, 0F); // Box 0
		bodyModel[32].setRotationPoint(-15F, -36.9F, 0F);
		bodyModel[32].rotateAngleX = -1.13446401F;

		bodyModel[33].addBox(-0.5F, -0.5F, -0.5F, 1, 8, 1, 0F); // Box 0
		bodyModel[33].setRotationPoint(-15F, -34.9F, -4F);
		bodyModel[33].rotateAngleX = -0.29670597F;

		bodyModel[34].addBox(-0.5F, -0.5F, -0.5F, 1, 8, 1, 0F); // Box 0
		bodyModel[34].setRotationPoint(-5F, -34.7F, 4F);
		bodyModel[34].rotateAngleX = 0.27925268F;

		bodyModel[35].addBox(-0.5F, -0.5F, -0.5F, 1, 5, 1, 0F); // Box 0
		bodyModel[35].setRotationPoint(-5F, -36.7F, 0F);
		bodyModel[35].rotateAngleX = 1.13446401F;

		bodyModel[36].addBox(-0.5F, -0.5F, -0.5F, 1, 5, 1, 0F); // Box 0
		bodyModel[36].setRotationPoint(-5F, -36.7F, 0F);
		bodyModel[36].rotateAngleX = -1.13446401F;

		bodyModel[37].addBox(-0.5F, -0.5F, -0.5F, 1, 8, 1, 0F); // Box 0
		bodyModel[37].setRotationPoint(-5F, -34.7F, -4F);
		bodyModel[37].rotateAngleX = -0.27925268F;

		bodyModel[38].addBox(-0.5F, -0.5F, -0.5F, 1, 8, 1, 0F); // Box 0
		bodyModel[38].setRotationPoint(3F, -34.5F, 4F);
		bodyModel[38].rotateAngleX = 0.26179939F;

		bodyModel[39].addBox(-0.5F, -0.5F, -0.5F, 1, 5, 1, 0F); // Box 0
		bodyModel[39].setRotationPoint(3F, -36.5F, 0F);
		bodyModel[39].rotateAngleX = 1.13446401F;

		bodyModel[40].addBox(-0.5F, -0.5F, -0.5F, 1, 5, 1, 0F); // Box 0
		bodyModel[40].setRotationPoint(3F, -36.5F, 0F);
		bodyModel[40].rotateAngleX = -1.13446401F;

		bodyModel[41].addBox(-0.5F, -0.5F, -0.5F, 1, 8, 1, 0F); // Box 0
		bodyModel[41].setRotationPoint(3F, -34.5F, -4F);
		bodyModel[41].rotateAngleX = -0.26179939F;

		bodyModel[42].addBox(-0.5F, -0.5F, -0.5F, 1, 47, 1, 0F); // Box 0
		bodyModel[42].setRotationPoint(-43F, -35.5F, 4F);
		bodyModel[42].rotateAngleZ = 1.55334303F;

		bodyModel[43].addBox(-0.5F, -0.5F, -0.5F, 1, 47, 1, 0F); // Box 0
		bodyModel[43].setRotationPoint(-43F, -35.5F, -4F);
		bodyModel[43].rotateAngleZ = 1.55334303F;

		bodyModel[44].addBox(0F, 0F, 0F, 9, 7, 10, 0F); // Box 0
		bodyModel[44].setRotationPoint(-53F, -30.5F, -5F);

		bodyModel[45].addBox(0F, 0F, 0F, 3, 3, 2, 0F); // Box 0
		bodyModel[45].setRotationPoint(-47F, -32.5F, -1F);
		bodyModel[45].rotateAngleZ = 0.01745329F;

		bodyModel[46].addBox(0F, 0F, 0F, 1, 2, 2, 0F); // Box 0
		bodyModel[46].setRotationPoint(-45.5F, -34.5F, -1F);
		bodyModel[46].rotateAngleZ = 0.01745329F;

		bodyModel[47].addShapeBox(0F, 0F, 0F, 6, 7, 16, 0F, 0F, 0F, 0F, -4F, 0F, 0F, -4F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -2F, 7F, 0F, -7F, 7F, 0F, -7F, 0F, 0F, -2F); // Box 0
		bodyModel[47].setRotationPoint(-50F, -22.5F, -8F);

		bodyModel[48].addBox(0F, 0F, 0F, 6, 6, 8, 0F); // Box 90
		bodyModel[48].setRotationPoint(-38F, -21.5F, -4F);

		bodyModel[49].addBox(0F, -1F, 0F, 2, 13, 8, 0F); // Box 91
		bodyModel[49].setRotationPoint(-31F, -32.5F, -4F);
		bodyModel[49].rotateAngleZ = -0.10471976F;

		bodyModel[50].addShapeBox(-0.5F, -0.5F, -0.5F, 1, 12, 1, 0F, -0.3F, 0F, -0.3F, -0.3F, 0F, -0.3F, -0.3F, 0F, -0.3F, -0.3F, 0F, -0.3F, -0.3F, 0F, -0.3F, -0.3F, 0F, -0.3F, -0.3F, 0F, -0.3F, -0.3F, 0F, -0.3F); // Box 0
		bodyModel[50].setRotationPoint(3F, -47.5F, 0F);

		bodyModel[51].addShapeBox(-0.5F, -0.5F, -0.5F, 62, 1, 1, 0F, 0F, -0.45F, -0.45F, 0F, -0.45F, -0.45F, 0F, -0.45F, -0.45F, 0F, -0.45F, -0.45F, 0F, -0.45F, -0.45F, 0F, -0.45F, -0.45F, 0F, -0.45F, -0.45F, 0F, -0.45F, -0.45F); // Box 0
		bodyModel[51].setRotationPoint(3.5F, -47.6F, 0F);
		bodyModel[51].rotateAngleZ = -0.01745329F;

		bodyModel[52].addShapeBox(-4.5F, -1F, -0.5F, 3, 1, 1, 0F, 0F, 0.1F, 0F, 0F, 0.1F, -0.2F, 0F, 0.1F, -0.2F, 0F, 0.1F, 0F, 0F, 0.3F, 0F, 0F, -0.1F, -0.2F, 0F, -0.1F, -0.2F, 0F, 0.3F, 0F); // Box 0
		bodyModel[52].setRotationPoint(12F, -32.5F, 0F);

		bodyModel[53].addShapeBox(3.5F, -1F, -0.5F, 4, 1, 1, 0F, 0F, 0F, -0.3F, 0F, 0F, -0.3F, 0F, 0F, -0.3F, 0F, 0F, -0.3F, 0F, -0.3F, -0.3F, 0F, -0.3F, -0.3F, 0F, -0.3F, -0.3F, 0F, -0.3F, -0.3F); // Box 0
		bodyModel[53].setRotationPoint(12F, -32.5F, 0F);

		bodyModel[54].addShapeBox(4.5F, -1.2F, -0.5F, 1, 1, 1, 0F, 0F, -0.35F, -0.35F, 0F, -0.35F, -0.35F, 0F, -0.35F, -0.35F, 0F, -0.35F, -0.35F, 0F, -0.35F, -0.35F, 0F, -0.35F, -0.35F, 0F, -0.35F, -0.35F, 0F, -0.35F, -0.35F); // Box 0
		bodyModel[54].setRotationPoint(15F, -32.5F, 0F);

		bodyModel[55].addShapeBox(0.2F, -1.9F, -1.5F, 3, 1, 3, 0F, 0F, -0.2F, -0.3F, 0F, -0.2F, -0.3F, 0F, -0.2F, -0.3F, 0F, -0.2F, -0.3F, 0F, -0.2F, -0.3F, 0F, -0.2F, -0.3F, 0F, -0.2F, -0.3F, 0F, -0.2F, -0.3F); // Box 0
		bodyModel[55].setRotationPoint(12F, -32.5F, 0F);

		bodyModel[56].addShapeBox(-1.5F, -1F, -0.5F, 5, 1, 1, 0F, 0F, 0.1F, -0.3F, 0F, 0.1F, -0.3F, 0F, 0.1F, -0.3F, 0F, 0.1F, -0.3F, 0F, 0.1F, -0.3F, 0F, -0.1F, -0.3F, 0F, -0.1F, -0.3F, 0F, 0.1F, -0.3F); // Box 0
		bodyModel[56].setRotationPoint(12F, -32.5F, 0F);

		bodyModel[57].addBox(0F, -1F, 0F, 2, 13, 8, 0F); // Box 0
		bodyModel[57].setRotationPoint(-9F, -32.5F, -4F);
		bodyModel[57].rotateAngleZ = 0.10471976F;

		bodyModel[58].addBox(0F, 0F, 0F, 6, 6, 8, 0F); // Box 0
		bodyModel[58].setRotationPoint(-7F, -21.5F, -4F);

		bodyModel[59].addBox(0F, 0F, 0F, 11, 11, 6, 0F); // Box 0
		bodyModel[59].setRotationPoint(-65F, -21.5F, -3F);
		bodyModel[59].rotateAngleZ = 0.12217305F;

		bodyModel[60].addShapeBox(0F, 0F, 0F, 23, 8, 8, 0F, 0F, 0F, 0F, 0F, -2F, -2F, 0F, -2F, -2F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -2F, -2F, 0F, -2F, -2F, 0F, 0F, 0F); // Box 0
		bodyModel[60].setRotationPoint(-42F, -10F, -4F);

		bodyModel[61].addShapeBox(0F, 0F, 0F, 8, 8, 8, 0F, 0F, -2F, -2F, 0F, -4F, -4F, 0F, -4F, -4F, 0F, -2F, -2F, 0F, -2F, -2F, 0F, -4F, -4F, 0F, -4F, -4F, 0F, -2F, -2F); // Box 0
		bodyModel[61].setRotationPoint(-19F, -10F, -4F);

		bodyModel[62].addShapeBox(0F, 0F, 0F, 9, 8, 8, 0F, 0F, -4F, -4F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -4F, -4F, 0F, -4F, -4F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -4F, -4F); // Box 0
		bodyModel[62].setRotationPoint(-51F, -10F, -4F);

		bodyModel[63].addBox(0F, 0F, 0F, 1, 8, 1, 0F); // Box 0
		bodyModel[63].setRotationPoint(-50F, -12F, -0.5F);
		bodyModel[63].rotateAngleZ = 0.57595865F;

		bodyModel[64].addBox(0F, 0F, 0F, 1, 5, 1, 0F); // Box 0
		bodyModel[64].setRotationPoint(-41F, -12F, -0.5F);

		bodyModel[65].addBox(0F, 0F, 0F, 1, 5, 1, 0F); // Box 0
		bodyModel[65].setRotationPoint(-28F, -12F, -0.5F);
		bodyModel[65].rotateAngleZ = -0.17453293F;

		bodyModel[66].addShapeBox(0F, -6F, -0.5F, 5, 12, 1, 0F, 0F, -2F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -2F, 0F, 0F, -2F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -2F, 0F); // Box 0
		bodyModel[66].setRotationPoint(-26F, -6F, 0F);
		bodyModel[66].rotateAngleX = 0.78539816F;

		bodyModel[67].addBox(0F, -6F, -0.5F, 12, 12, 1, 0F); // Box 0
		bodyModel[67].setRotationPoint(-21F, -6F, 0F);
		...
		tailModel[0] = new ModelRendererTurbo(this, 1, 113, textureX, textureY); // Box 0
		tailModel[1] = new ModelRendererTurbo(this, 433, 73, textureX, textureY); // Box 0
		tailModel[2] = new ModelRendererTurbo(this, 201, 113, textureX, textureY); // Box 0
		tailModel[3] = new ModelRendererTurbo(this, 401, 121, textureX, textureY); // Box 0
		tailModel[4] = new ModelRendererTurbo(this, 497, 1, textureX, textureY); // Box 0
		tailModel[5] = new ModelRendererTurbo(this, 497, 97, textureX, textureY); // Box 0
		tailModel[6] = new ModelRendererTurbo(this, 201, 25, textureX, textureY); // Box 0
		tailModel[7] = new ModelRendererTurbo(this, 385, 169, textureX, textureY); // Box 0
		tailModel[8] = new ModelRendererTurbo(this, 1, 185, textureX, textureY); // Box 0
		tailModel[9] = new ModelRendererTurbo(this, 121, 185, textureX, textureY); // Box 0
		tailModel[10] = new ModelRendererTurbo(this, 201, 193, textureX, textureY); // Box 0
		tailModel[11] = new ModelRendererTurbo(this, 289, 1, textureX, textureY); // Box 0
		tailModel[12] = new ModelRendererTurbo(this, 321, 1, textureX, textureY); // Box 0
		tailModel[13] = new ModelRendererTurbo(this, 369, 17, textureX, textureY); // Box 0
		tailModel[14] = new ModelRendererTurbo(this, 385, 17, textureX, textureY); // Box 0
		tailModel[15] = new ModelRendererTurbo(this, 401, 17, textureX, textureY); // Box 0

		tailModel[0].addShapeBox(0F, 0F, 0F, 31, 11, 9, 0F, 0F, -7F, -5F, 0F, -9F, -9F, 1F, -9F, 0F, 0F, -4F, 0F, 0F, 0F, -3.5F, 0F, -2F, -9F, 0F, -2F, 0F, 0F, 0F, 0F); // Box 0
		tailModel[0].setRotationPoint(50F, -32.5F, -9F);

		tailModel[1].addShapeBox(0F, 0F, 0F, 30, 11, 9, 0F, 0F, -4F, 0F, 1F, -9F, 0F, 0F, -9F, -9F, 0F, -7F, -5F, 0F, 0F, 0F, 0F, -2F, 0F, 0F, -2F, -9F, 0F, 0F, -3.5F); // Box 0
		tailModel[1].setRotationPoint(50F, -32.5F, 0F);

		tailModel[2].addShapeBox(0F, 0F, 0F, 31, 9, 9, 0F, 0F, 0F, -3.5F, 0F, 2F, -9F, 0F, 2F, 0F, 0F, 0F, 0F, 0F, -7F, -5F, 0F, -11F, -9F, 0F, -11F, 0F, 0F, -4.5F, 0F); // Box 0
		tailModel[2].setRotationPoint(50F, -21.5F, -9F);

		tailModel[3].addShapeBox(0F, 0F, 0F, 31, 9, 9, 0F, 0F, 0F, 0F, 0F, 2F, 0F, 0F, 2F, -9F, 0F, 0F, -3.5F, 0F, -4.5F, 0F, 0F, -11F, 0F, 0F, -11F, -9F, 0F, -7F, -5F); // Box 0
		tailModel[3].setRotationPoint(50F, -21.5F, 0F);

		tailModel[4].addShapeBox(0F, 0F, -0.5F, 5, 23, 1, 0F, 0F, 0F, 0F, 0F, 3F, 0F, 0F, 3F, 0F, 0F, 0F, 0F, 12F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 12F, 0F, 0F); // Box 0
		tailModel[4].setRotationPoint(61F, -48F, 0F);

		tailModel[5].addShapeBox(0F, 0F, -0.5F, 5, 23, 1, 0F, 0F, -3F, 0F, 3F, -3F, 0F, 3F, -3F, 0F, 0F, -3F, 0F, 0F, 0F, 0F, 6F, 1F, 0F, 6F, 1F, 0F, 0F, 0F, 0F); // Box 0
		tailModel[5].setRotationPoint(66F, -48F, 0F);

		tailModel[6].addShapeBox(0F, 0F, -0.5F, 5, 9, 1, 0F, 0F, -3F, 0F, -1F, -4F, 0F, -1F, -4F, 0F, 0F, -3F, 0F, 0F, 0F, 0F, 3F, 0F, 0F, 3F, 0F, 0F, 0F, 0F, 0F); // Box 0
		tailModel[6].setRotationPoint(66F, -54F, 0F);

		tailModel[7].addShapeBox(0F, 0F, -0.5F, 16, 1, 40, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -8F, 0F, -9F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -8F, 0F, -9F); // Box 0
		tailModel[7].setRotationPoint(53F, -23F, 0F);

		tailModel[8].addShapeBox(0F, 0F, -0.5F, 16, 1, 40, 0F, -8F, 0F, -9F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -8F, 0F, -9F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 0
		tailModel[8].setRotationPoint(53F, -23F, -40F);

		tailModel[9].addShapeBox(0F, 0F, -0.5F, 16, 1, 40, 0F, 0F, 0F, 0F, -11F, 0F, -5F, -5F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -11F, 0F, -5F, -5F, 0F, 0F, 0F, 0F, 0F); // Box 0
		tailModel[9].setRotationPoint(69F, -23F, -40F);

		tailModel[10].addShapeBox(0F, 0F, -0.5F, 16, 1, 40, 0F, 0F, 0F, 0F, -5F, 0F, 0F, -11F, 0F, -5F, 0F, 0F, 0F, 0F, 0F, 0F, -5F, 0F, 0F, -11F, 0F, -5F, 0F, 0F, 0F); // Box 0
		tailModel[10].setRotationPoint(69F, -23F, 0F);

		tailModel[11].addShapeBox(0F, 0F, -0.5F, 3, 3, 1, 0F, 3F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 3F, 0F, 0F, 0F, 0F, 0F, -0.5F, 0F, 0F, -0.5F, 0F, 0F, 0F, 0F, 0F); // Box 0
		tailModel[11].setRotationPoint(71F, -22F, 0F);

		tailModel[12].addShapeBox(0F, 0F, -0.5F, 1, 4, 1, 0F, 0F, 0F, -0.4F, 0F, 0F, -0.4F, 0F, 0F, -0.4F, 0F, 0F, -0.4F, 0F, 0F, -0.4F, 0F, 0F, -0.4F, 0F, 0F, -0.4F, 0F, 0F, -0.4F); // Box 0
		tailModel[12].setRotationPoint(71F, -20F, 0.7F);
		tailModel[12].rotateAngleZ = 0.52359878F;

		tailModel[13].addShapeBox(0F, 0F, -0.5F, 4, 1, 1, 0F, -1F, 0F, 0F, -1F, 0F, 0F, -1F, 0F, 0F, -1F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 0
		tailModel[13].setRotationPoint(72F, -18.5F, 0F);

		tailModel[14].addShapeBox(0F, 0F, -0.5F, 4, 1, 1, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -1F, 0F, 0F, -1F, 0F, 0F, -1F, 0F, 0F, -1F, 0F, 0F); // Box 0
		tailModel[14].setRotationPoint(72F, -15.5F, 0F);

		tailModel[15].addBox(0F, 0F, -0.5F, 4, 2, 1, 0F); // Box 0
		tailModel[15].setRotationPoint(72F, -17.5F, 0F);
        ...
        propellerModels[0][0] = new ModelRendererTurbo(this, 377, 1, textureX, textureY); //Propeller 0 - Blade 0 : 192, 12 is the texture origin
        propellerModels[0][1] = new ModelRendererTurbo(this, 377, 1, textureX, textureY); //Propeller 0 - Blade 1
        propellerModels[0][2] = new ModelRendererTurbo(this, 377, 1, textureX, textureY); //Propeller 0 - Blade 2		
        propellerModels[0][0].addBox(0F, 0F, -1F, 1, 22, 2, 0F);		//Propeller Blades
        propellerModels[0][1].addBox(0F, 0F, -1F, 1, 22, 2, 0F);		//They will all be the same
        propellerModels[0][2].addBox(0F, 0F, -1F, 1, 22, 2, 0F);		
        propellerModels[0][0].setRotationPoint(-79F, -21.5F, 0F);	//Set the position of the propeller
        propellerModels[0][1].setRotationPoint(-79F, -21.5F, 0F);	
        propellerModels[0][2].setRotationPoint(-79F, -21.5F, 0F);	
