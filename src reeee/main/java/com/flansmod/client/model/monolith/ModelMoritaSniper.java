...
public class ModelMoritaSniper extends ModelGun //Same as Filename
{
	int textureX = 256;
	int textureY = 256;

	public ModelMoritaSniper() //Same as Filename
	{
		...
		gunModel[42] = new ModelRendererTurbo(this, 77, 92, textureX, textureY); // Box 23
		gunModel[43] = new ModelRendererTurbo(this, 45, 92, textureX, textureY); // Box 24
		gunModel[44] = new ModelRendererTurbo(this, 37, 92, textureX, textureY); // Box 25
		...
		gunModel[57] = new ModelRendererTurbo(this, 25, 41, textureX, textureY); // Box 41
		gunModel[58] = new ModelRendererTurbo(this, 33, 41, textureX, textureY); // Box 42
		gunModel[59] = new ModelRendererTurbo(this, 41, 41, textureX, textureY); // Box 44
		gunModel[60] = new ModelRendererTurbo(this, 49, 41, textureX, textureY); // Box 1
		gunModel[61] = new ModelRendererTurbo(this, 73, 41, textureX, textureY); // Box 2
		gunModel[62] = new ModelRendererTurbo(this, 38, 84, textureX, textureY); // Box 3
		gunModel[63] = new ModelRendererTurbo(this, 121, 41, textureX, textureY); // Box 8
		gunModel[64] = new ModelRendererTurbo(this, 41, 65, textureX, textureY); // Box 14
		gunModel[65] = new ModelRendererTurbo(this, 49, 65, textureX, textureY); // Box 15
		gunModel[66] = new ModelRendererTurbo(this, 17, 73, textureX, textureY); // Box 21
		gunModel[67] = new ModelRendererTurbo(this, 121, 65, textureX, textureY); // Box 22
		gunModel[68] = new ModelRendererTurbo(this, 33, 73, textureX, textureY); // Box 23
		gunModel[69] = new ModelRendererTurbo(this, 49, 73, textureX, textureY); // Box 25
		gunModel[70] = new ModelRendererTurbo(this, 57, 73, textureX, textureY); // Box 26
		gunModel[71] = new ModelRendererTurbo(this, 73, 73, textureX, textureY); // Box 27
		gunModel[72] = new ModelRendererTurbo(this, 81, 73, textureX, textureY); // Box 28
		gunModel[73] = new ModelRendererTurbo(this, 89, 73, textureX, textureY); // Box 29
		gunModel[74] = new ModelRendererTurbo(this, 97, 73, textureX, textureY); // Box 30
		gunModel[75] = new ModelRendererTurbo(this, 1, 97, textureX, textureY); // Box 0
		gunModel[76] = new ModelRendererTurbo(this, 1, 90, textureX, textureY); // Box 1
		gunModel[77] = new ModelRendererTurbo(this, 2, 84, textureX, textureY); // Box 2
		gunModel[78] = new ModelRendererTurbo(this, 18, 110, textureX, textureY); // Box 3
		gunModel[79] = new ModelRendererTurbo(this, 5, 110, textureX, textureY); // Box 4
		gunModel[80] = new ModelRendererTurbo(this, 16, 104, textureX, textureY); // Box 5
		gunModel[81] = new ModelRendererTurbo(this, 40, 104, textureX, textureY); // Box 6
		gunModel[82] = new ModelRendererTurbo(this, 4, 103, textureX, textureY); // Box 7
		gunModel[83] = new ModelRendererTurbo(this, 5, 110, textureX, textureY); // Box 8
		gunModel[84] = new ModelRendererTurbo(this, 47, 81, textureX, textureY); // Box 9
		gunModel[85] = new ModelRendererTurbo(this, 76, 104, textureX, textureY); // Box 10
		gunModel[86] = new ModelRendererTurbo(this, 76, 99, textureX, textureY); // Box 11
		gunModel[87] = new ModelRendererTurbo(this, 76, 99, textureX, textureY); // Box 12
		gunModel[88] = new ModelRendererTurbo(this, 47, 85, textureX, textureY); // Box 13
		gunModel[89] = new ModelRendererTurbo(this, 69, 99, textureX, textureY); // Box 14
		gunModel[90] = new ModelRendererTurbo(this, 69, 99, textureX, textureY); // Box 15
		gunModel[91] = new ModelRendererTurbo(this, 54, 81, textureX, textureY); // Box 16
		gunModel[92] = new ModelRendererTurbo(this, 54, 86, textureX, textureY); // Box 17
		gunModel[93] = new ModelRendererTurbo(this, 60, 98, textureX, textureY); // Box 18
		gunModel[94] = new ModelRendererTurbo(this, 60, 103, textureX, textureY); // Box 19
		gunModel[95] = new ModelRendererTurbo(this, 143, 64, textureX, textureY); // Box 0
		gunModel[96] = new ModelRendererTurbo(this, 154, 69, textureX, textureY); // Box 1
		gunModel[97] = new ModelRendererTurbo(this, 154, 69, textureX, textureY); // Box 2
		gunModel[98] = new ModelRendererTurbo(this, 144, 82, textureX, textureY); // Box 3
		gunModel[99] = new ModelRendererTurbo(this, 158, 82, textureX, textureY); // Box 4
		gunModel[100] = new ModelRendererTurbo(this, 169, 82, textureX, textureY); // Box 5
		gunModel[101] = new ModelRendererTurbo(this, 154, 75, textureX, textureY); // Box 6
		gunModel[102] = new ModelRendererTurbo(this, 146, 91, textureX, textureY); // Box 7
		gunModel[103] = new ModelRendererTurbo(this, 146, 95, textureX, textureY); // Box 8
		gunModel[104] = new ModelRendererTurbo(this, 146, 87, textureX, textureY); // Box 9
		gunModel[105] = new ModelRendererTurbo(this, 157, 87, textureX, textureY); // Box 10
		gunModel[106] = new ModelRendererTurbo(this, 157, 91, textureX, textureY); // Box 11
		gunModel[107] = new ModelRendererTurbo(this, 157, 95, textureX, textureY); // Box 12
		gunModel[108] = new ModelRendererTurbo(this, 143, 68, textureX, textureY); // Box 13
		gunModel[109] = new ModelRendererTurbo(this, 143, 68, textureX, textureY); // Box 14
		gunModel[110] = new ModelRendererTurbo(this, 163, 75, textureX, textureY); // Box 15
		gunModel[111] = new ModelRendererTurbo(this, 143, 73, textureX, textureY); // Box 16

		gunModel[0].addShapeBox(-4.3F, -3F, -1F, 9, 1, 2, 0F, 0F, -.4F, -.1F, 0F, -.4F, -.1F, -.4F, -.4F, -.1F, 0F, -.4F, -.1F, 0F, 0F, -.1F, -.4F, 0F, -.1F, -.4F, 0F, -.1F, 0F, 0F, -.1F); // Box 0
		...
		gunModel[13].addShapeBox(2.8F, -1F, -0.5F, 1, 1, 1, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -.6F, 0F, 0F, -.6F, 0F, 0F, -.6F, 0F, 0F, -.6F, 0F); // Box 15
		...
		gunModel[36].addShapeBox(-4.3F, -2F, -1F, 8, 1, 2, 0F, 0F, 0F, -.15F, .3F, 0F, -.15F, .3F, 0F, -.15F, 0F, 0F, -.15F, 0F, -.95F, -.15F, .3F, -.95F, -.15F, .3F, -.95F, -.15F, 0F, -.95F, -.15F); // Box 15
		...
		gunModel[42].addShapeBox(10F, -7F, -1F, 2, 2, 2, 0F, .5F, .4F, -.2F, -1.3F, .4F, -.2F, -1.3F, .4F, -.2F, .5F, .4F, -.2F, -.8F, 0F, -.2F, 0F, 0F, -.2F, 0F, 0F, -.2F, -.8F, 0F, -.2F); // Box 23
		gunModel[42].setRotationPoint(0F, 0F, 0F);

		gunModel[43].addShapeBox(-1F, -7.4F, -1F, 12, 1, 2, 0F, 0F, 0F, -.2F, -.5F, 0F, -.2F, -.5F, 0F, -.2F, 0F, 0F, -.2F, 0F, -.2F, -.2F, 0F, -.2F, -.2F, 0F, -.2F, -.2F, 0F, -.2F, -.2F); // Box 24
		gunModel[43].setRotationPoint(0F, 0F, 0F);

		gunModel[44].addShapeBox(-2F, -7.4F, -1F, 1, 1, 2, 0F, -.2F, 0F, -.2F, 0F, 0F, -.2F, 0F, 0F, -.2F, -.2F, 0F, -.2F, .3F, -.2F, -.2F, 0F, -.2F, -.2F, 0F, -.2F, -.2F, .3F, -.2F, -.2F); // Box 25
		...
		gunModel[57].addShapeBox(-4.7F, -2.2F, -1F, 1, 1, 2, 0F, -.2F, -.4F, -.2F, -.2F, -.4F, -.2F, -.2F, -.4F, -.2F, -.2F, -.4F, -.2F, -.4F, -.4F, -.2F, -.4F, -.4F, -.2F, -.4F, -.4F, -.2F, -.4F, -.4F, -.2F); // Box 41
		gunModel[57].setRotationPoint(0F, 0F, 0F);

		gunModel[58].addShapeBox(-4.7F, -2.4F, -1F, 1, 1, 2, 0F, -.2F, -.4F, -.2F, -.2F, -.4F, -.2F, -.2F, -.4F, -.2F, -.2F, -.4F, -.2F, -.2F, -.4F, -.2F, -.2F, -.4F, -.2F, -.2F, -.4F, -.2F, -.2F, -.4F, -.2F); // Box 42
		gunModel[58].setRotationPoint(0F, 0F, 0F);

		gunModel[59].addShapeBox(-12.8F, -3.4F, -1F, 1, 3, 2, 0F, .4F, 0F, -.4F, 0F, 0F, -.4F, 0F, 0F, -.4F, .4F, 0F, -.4F, .4F, 0F, -.4F, 0F, 0F, -.4F, 0F, 0F, -.4F, .4F, 0F, -.4F); // Box 44
		gunModel[59].setRotationPoint(0F, 0F, 0F);

		gunModel[60].addShapeBox(-11F, -4.4F, 0.8F, 7, 1, 1, 0F, 0F, .3F, 0F, 0F, .3F, 0F, 0F, .3F, -.9F, 0F, .3F, -.9F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -.9F, 0F, 0F, -.9F); // Box 1
		gunModel[60].setRotationPoint(0F, 0F, 0F);

		gunModel[61].addShapeBox(-11F, -5.4F, 0.8F, 7, 1, 1, 0F, -.5F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -.9F, -.5F, 0F, -.9F, 0F, -.3F, 0F, 0F, -.3F, 0F, 0F, -.3F, -.9F, 0F, -.3F, -.9F); // Box 2
		gunModel[61].setRotationPoint(0F, 0F, 0F);

		gunModel[62].addShapeBox(4.2F, -4.5F, -1F, 1, 1, 2, 0F, -.6F, .4F, -.4F, -.2F, .4F, -.4F, -.2F, .4F, -.4F, -.6F, .4F, -.4F, 0F, -.5F, -.2F, -.2F, -.5F, -.2F, -.2F, -.5F, -.2F, 0F, -.5F, -.2F); // Box 3
		gunModel[62].setRotationPoint(0F, 0F, 0F);

		gunModel[63].addShapeBox(0.5F, -2F, -0.5F, 1, 1, 1, 0F, 0F, 0F, -.3F, 0F, 0F, -.3F, 0F, 0F, -.3F, 0F, 0F, -.3F, 0F, -.2F, -.3F, -.2F, -.2F, -.3F, -.2F, -.2F, -.3F, 0F, -.2F, -.3F); // Box 8
		gunModel[63].setRotationPoint(0F, 0F, 0F);

		gunModel[64].addShapeBox(-12.8F, -4.4F, -1F, 1, 1, 2, 0F, .5F, -.2F, -.6F, 0F, -.2F, -.6F, 0F, -.2F, -.6F, .5F, -.2F, -.6F, .4F, 0F, -.4F, 0F, 0F, -.4F, 0F, 0F, -.4F, .4F, 0F, -.4F); // Box 14
		gunModel[64].setRotationPoint(0F, 0F, 0F);

		gunModel[65].addShapeBox(-12.8F, -0.4F, -1F, 1, 1, 2, 0F, .4F, 0F, -.4F, 0F, 0F, -.4F, 0F, 0F, -.4F, .4F, 0F, -.4F, .5F, .2F, -.6F, 0F, -.4F, -.6F, 0F, -.4F, -.6F, .5F, .2F, -.6F); // Box 15
		gunModel[65].setRotationPoint(0F, 0F, 0F);

		gunModel[66].addShapeBox(-10F, -3.8F, -0.5F, 6, 1, 1, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 21
		gunModel[66].setRotationPoint(0F, 0F, 0F);

		gunModel[67].addShapeBox(-10F, -4.8F, -0.5F, 1, 1, 1, 0F, 0F, -.4F, 0F, 0F, -.4F, 0F, 0F, -.4F, 0F, 0F, -.4F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 22
		gunModel[67].setRotationPoint(0F, 0F, 0F);

		gunModel[68].addShapeBox(-9F, -4.8F, -0.5F, 1, 1, 1, 0F, 0F, -.4F, 0F, 0F, -.4F, 0F, 0F, -.4F, 0F, 0F, -.4F, 0F, 0F, -.4F, 0F, 0F, -.4F, 0F, 0F, -.4F, 0F, 0F, -.4F, 0F); // Box 23
		gunModel[68].setRotationPoint(0F, 0F, 0F);

		gunModel[69].addShapeBox(-5F, -4.8F, -0.5F, 1, 1, 1, 0F, 0F, -.4F, 0F, 0F, -.4F, 0F, 0F, -.4F, 0F, 0F, -.4F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 25
		gunModel[69].setRotationPoint(0F, 0F, 0F);

		gunModel[70].addShapeBox(-10F, -4.8F, -0.5F, 6, 2, 1, 0F, 0F, -.7F, -.4F, 0F, -.7F, -.4F, 0F, -.7F, -.4F, 0F, -.7F, -.4F, 0F, 0F, -.4F, 0F, 0F, -.4F, 0F, 0F, -.4F, 0F, 0F, -.4F); // Box 26
		gunModel[70].setRotationPoint(0F, 0F, 0F);

		gunModel[71].addShapeBox(-5.1F, -4.8F, -1.5F, 1, 1, 1, 0F, 0F, -.4F, -.6F, -.2F, -.4F, -.6F, -.2F, -.4F, 0F, 0F, -.4F, 0F, 0F, 0F, -.6F, -.2F, 0F, -.6F, -.2F, 0F, 0F, 0F, 0F, 0F); // Box 27
		gunModel[71].setRotationPoint(0F, 0F, 0F);

		gunModel[72].addShapeBox(-6.1F, -4.8F, -1.5F, 1, 1, 1, 0F, -.8F, -.5F, -.6F, 0F, -.4F, -.6F, 0F, -.4F, 0F, -.8F, -.5F, 0F, -.8F, 0F, -.6F, 0F, 0F, -.6F, 0F, 0F, 0F, -.8F, 0F, 0F); // Box 28
		gunModel[72].setRotationPoint(0F, 0F, 0F);

		gunModel[73].addShapeBox(-6.3F, -4.8F, -1.5F, 1, 1, 1, 0F, -.3F, -.7F, -.6F, 0F, -.5F, -.6F, 0F, -.5F, 0F, -.3F, -.7F, 0F, -.3F, 0F, -.6F, 0F, 0F, -.6F, 0F, 0F, 0F, -.3F, 0F, 0F); // Box 29
		gunModel[73].setRotationPoint(0F, 0F, 0F);

		gunModel[74].addShapeBox(-6.3F, -4.8F, -2.5F, 1, 1, 2, 0F, -.3F, -.7F, -1.3F, -.6F, -.7F, -1.3F, -.6F, -.7F, 0F, -.3F, -.7F, 0F, -.3F, 0F, -1.3F, -.6F, 0F, -1.3F, -.6F, 0F, 0F, -.3F, 0F, 0F); // Box 30
		gunModel[74].setRotationPoint(0F, 0F, 0F);

		gunModel[75].addShapeBox(4F, -4F, -1F, 15, 1, 2, 0F, 0F, 0F, -.2F, 0F, 0F, -.2F, 0F, 0F, -.2F, 0F, 0F, -.2F, 0F, 0F, -.1F, 0F, 0F, -.1F, 0F, 0F, -.1F, 0F, 0F, -.1F); // Box 0
		gunModel[75].setRotationPoint(0F, 0F, 0F);

		gunModel[76].addShapeBox(4F, -3F, -1F, 15, 1, 2, 0F, 0F, 0F, -.1F, 0F, 0F, -.1F, 0F, 0F, -.1F, 0F, 0F, -.1F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 1
		gunModel[76].setRotationPoint(0F, 0F, 0F);

		gunModel[77].addShapeBox(4F, -2F, -1F, 14, 1, 2, 0F, 0F, 0F, -.15F, 0F, 0F, -.15F, 0F, 0F, -.15F, 0F, 0F, -.15F, 0F, -.95F, -.15F, 0F, -.95F, -.15F, 0F, -.95F, -.15F, 0F, -.95F, -.15F); // Box 2
		gunModel[77].setRotationPoint(0F, 0F, 0F);

		gunModel[78].addShapeBox(3.8F, -2F, -0.5F, 5, 1, 1, 0F, 0F, 0F, .4F, 0F, 0F, .4F, 0F, 0F, .4F, 0F, 0F, .4F, 0F, .4F, .1F, 0F, .4F, .1F, 0F, .4F, .1F, 0F, .4F, .1F); // Box 3
		gunModel[78].setRotationPoint(0F, 0F, 0F);

		gunModel[79].addShapeBox(8.8F, -2F, -0.5F, 4, 1, 1, 0F, 0F, 0F, .4F, 0F, 0F, .4F, 0F, 0F, .4F, 0F, 0F, .4F, 0F, -.2F, .22F, 0F, -.2F, .22F, 0F, -.2F, .22F, 0F, -.2F, .22F); // Box 4
		gunModel[79].setRotationPoint(0F, 0F, 0F);

		gunModel[80].addShapeBox(10F, -5F, -1F, 9, 1, 2, 0F, 0F, -.5F, -.25F, 0F, -.5F, -.25F, 0F, -.5F, -.25F, 0F, -.5F, -.25F, .5F, 0F, -.2F, 0F, 0F, -.2F, 0F, 0F, -.2F, .5F, 0F, -.2F); // Box 5
		gunModel[80].setRotationPoint(0F, 0F, 0F);

		gunModel[81].addShapeBox(12F, -5F, -1F, 7, 1, 2, 0F, 0F, 0F, -.4F, -.3F, 0F, -.4F, -.3F, 0F, -.4F, 0F, 0F, -.4F, 0F, -.5F, -.25F, 0F, -.5F, -.25F, 0F, -.5F, -.25F, 0F, -.5F, -.25F); // Box 6
		gunModel[81].setRotationPoint(0F, 0F, 0F);

		gunModel[82].addShapeBox(11F, -5F, -1F, 1, 2, 2, 0F, .2F, 0F, -.2F, 0F, 0F, -.2F, 0F, 0F, -.2F, .2F, 0F, -.2F, .2F, -.5F, -.2F, 0F, -.5F, -.2F, 0F, -.5F, -.2F, .2F, -.5F, -.2F); // Box 7
		gunModel[82].setRotationPoint(0F, 0F, 0F);

		gunModel[83].addShapeBox(11.8F, -2F, -0.5F, 1, 1, 1, 0F, 0F, -.8F, .22F, 0F, -.8F, .22F, 0F, -.8F, .22F, 0F, -.8F, .22F, -.1F, 0F, .22F, -.1F, 0F, .22F, -.1F, 0F, .22F, -.1F, 0F, .22F); // Box 8
		gunModel[83].setRotationPoint(0F, 0F, 0F);

		gunModel[84].addShapeBox(19F, -4F, -0.5F, 1, 1, 1, 0F, 0F, 0F, -.2F, .3F, 0F, -.2F, .3F, 0F, -.2F, 0F, 0F, -.2F, 0F, -.5F, 0F, .3F, -.5F, 0F, .3F, -.5F, 0F, 0F, -.5F, 0F); // Box 9
		gunModel[84].setRotationPoint(0F, 0F, 0F);

		gunModel[85].addShapeBox(12F, -2F, -0.5F, 4, 1, 1, 0F, 0F, -.1F, -.1F, 0F, -.1F, -.1F, 0F, -.1F, -.1F, 0F, -.1F, -.1F, 0F, -.1F, -.1F, 0F, -.1F, -.1F, 0F, -.1F, -.1F, 0F, -.1F, -.1F); // Box 10
		gunModel[85].setRotationPoint(0F, 0F, 0F);

		gunModel[86].addShapeBox(15F, -2F, -0.5F, 3, 1, 1, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -.5F, .2F, 0F, -.5F, .2F, 0F, -.5F, .2F, 0F, -.5F, .2F); // Box 11
		gunModel[86].setRotationPoint(0F, 0F, 0F);

		gunModel[87].addShapeBox(15F, -2F, -0.5F, 3, 1, 1, 0F, 0F, -.5F, .2F, 0F, -.5F, .2F, 0F, -.5F, .2F, 0F, -.5F, .2F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 12
		gunModel[87].setRotationPoint(0F, 0F, 0F);

		gunModel[88].addShapeBox(19F, -4F, -0.5F, 1, 1, 1, 0F, 0F, -.5F, 0F, .3F, -.5F, 0F, .3F, -.5F, 0F, 0F, -.5F, 0F, 0F, 0F, -.2F, .3F, 0F, -.2F, .3F, 0F, -.2F, 0F, 0F, -.2F); // Box 13
		gunModel[88].setRotationPoint(0F, 0F, 0F);

		gunModel[89].addShapeBox(18F, -2F, -0.5F, 1, 1, 1, 0F, 0F, -.1F, -.1F, 0F, -.1F, -.1F, 0F, -.1F, -.1F, 0F, -.1F, -.1F, 0F, -.5F, .1F, 0F, -.5F, .1F, 0F, -.5F, .1F, 0F, -.5F, .1F); // Box 14
		gunModel[89].setRotationPoint(0F, 0F, 0F);

		gunModel[90].addShapeBox(18F, -2F, -0.5F, 1, 1, 1, 0F, 0F, -.5F, .1F, 0F, -.5F, .1F, 0F, -.5F, .1F, 0F, -.5F, .1F, 0F, -.1F, -.1F, 0F, -.1F, -.1F, 0F, -.1F, -.1F, 0F, -.1F, -.1F); // Box 15
		gunModel[90].setRotationPoint(0F, 0F, 0F);

		gunModel[91].addShapeBox(19F, -3F, -0.5F, 2, 1, 1, 0F, 0F, -.1F, -.2F, 0F, -.1F, -.2F, 0F, -.1F, -.2F, 0F, -.1F, -.2F, 0F, -.5F, 0F, 0F, -.5F, 0F, 0F, -.5F, 0F, 0F, -.5F, 0F); // Box 16
		gunModel[91].setRotationPoint(0F, 0F, 0F);

		gunModel[92].addShapeBox(19F, -3F, -0.5F, 2, 1, 1, 0F, 0F, -.5F, 0F, 0F, -.5F, 0F, 0F, -.5F, 0F, 0F, -.5F, 0F, 0F, -.1F, -.2F, 0F, -.1F, -.2F, 0F, -.1F, -.2F, 0F, -.1F, -.2F); // Box 17
		gunModel[92].setRotationPoint(0F, 0F, 0F);

		gunModel[93].addShapeBox(18F, -2.3F, -0.5F, 2, 1, 1, 0F, 0F, 0F, -.3F, 0F, 0F, -.3F, 0F, 0F, -.3F, 0F, 0F, -.3F, 0F, -.5F, -.3F, 0F, -.5F, -.3F, 0F, -.5F, -.3F, 0F, -.5F, -.3F); // Box 18
		gunModel[93].setRotationPoint(0F, 0F, 0F);

		gunModel[94].addShapeBox(18F, -2.3F, -0.5F, 1, 1, 1, 0F, 0F, -.5F, -.3F, .5F, -.5F, -.3F, .5F, -.5F, -.3F, 0F, -.5F, -.3F, 0F, 0F, -.3F, .2F, 0F, -.3F, .2F, 0F, -.3F, 0F, 0F, -.3F); // Box 19
		gunModel[94].setRotationPoint(0F, 0F, 0F);

		gunModel[95].addShapeBox(2F, -8.4F, -1F, 7, 1, 2, 0F, 0F, -.5F, -.1F, 0F, -.5F, -.1F, 0F, -.5F, -.1F, 0F, -.5F, -.1F, 0F, 0F, -.1F, 0F, 0F, -.1F, 0F, 0F, -.1F, 0F, 0F, -.1F); // Box 0
		gunModel[95].setRotationPoint(0F, 0F, 0F);

		gunModel[96].addShapeBox(3F, -9.9F, -1F, 5, 2, 2, 0F, 0F, 0F, -.1F, 0F, 0F, -.1F, 0F, 0F, -.1F, 0F, 0F, -.1F, .5F, 0F, -.1F, 0F, 0F, -.1F, 0F, 0F, -.1F, .5F, 0F, -.1F); // Box 1
		gunModel[96].setRotationPoint(0F, 0F, 0F);

		gunModel[97].addShapeBox(2F, -8.9F, -1F, 1, 1, 2, 0F, 0F, 0F, -.1F, 0F, 0F, -.1F, 0F, 0F, -.1F, 0F, 0F, -.1F, 0F, 0F, -.1F, 0F, 0F, -.1F, 0F, 0F, -.1F, 0F, 0F, -.1F); // Box 2
		gunModel[97].setRotationPoint(0F, 0F, 0F);

		gunModel[98].addShapeBox(-2.5F, -8.6F, -0.5F, 5, 1, 1, 0F, .1F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, .1F, 0F, 0F, .8F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, .8F, 0F, 0F); // Box 3
		gunModel[98].setRotationPoint(0F, 0F, 0F);

		gunModel[99].addShapeBox(-2F, -8.6F, -0.5F, 3, 1, 1, 0F, 0F, .1F, .1F, 0F, .1F, .1F, 0F, .1F, .1F, 0F, .1F, .1F, 0F, .1F, .1F, 0F, .1F, .1F, 0F, .1F, .1F, 0F, .1F, .1F); // Box 4
		gunModel[99].setRotationPoint(0F, 0F, 0F);

		gunModel[100].addShapeBox(-3.5F, -8.6F, -0.5F, 1, 1, 1, 0F, -.8F, .1F, .1F, 0F, .1F, .1F, 0F, .1F, .1F, -.8F, .1F, .1F, 0F, .1F, .1F, -.8F, .1F, .1F, -.8F, .1F, .1F, 0F, .1F, .1F); // Box 5
		gunModel[100].setRotationPoint(0F, 0F, 0F);

		gunModel[101].addShapeBox(8F, -9.5F, -0.5F, 1, 1, 1, 0F, 0F, .2F, .2F, 0F, .2F, .2F, 0F, .2F, .2F, 0F, .2F, .2F, 0F, .2F, .2F, 0F, .2F, .2F, 0F, .2F, .2F, 0F, .2F, .2F); // Box 6
		gunModel[101].setRotationPoint(0F, 0F, 0F);

		gunModel[102].addShapeBox(9F, -9.5F, -0.5F, 3, 1, 1, 0F, 0F, -.1F, .1F, 0F, -.1F, .7F, 0F, -.1F, .7F, 0F, -.1F, .1F, 0F, -.1F, .1F, 0F, -.1F, .7F, 0F, -.1F, .7F, 0F, -.1F, .1F); // Box 7
		gunModel[102].setRotationPoint(0F, 0F, 0F);

		gunModel[103].addShapeBox(9F, -8.7F, -0.5F, 3, 1, 1, 0F, 0F, -.1F, .1F, 0F, -.1F, .7F, 0F, -.1F, .7F, 0F, -.1F, .1F, 0F, -.7F, .1F, 0F, -.1F, .1F, 0F, -.1F, .1F, 0F, -.7F, .1F); // Box 8
		gunModel[103].setRotationPoint(0F, 0F, 0F);

		gunModel[104].addShapeBox(9F, -10.3F, -0.5F, 3, 1, 1, 0F, 0F, -.7F, .1F, 0F, -.1F, .1F, 0F, -.1F, .1F, 0F, -.7F, .1F, 0F, -.1F, .1F, 0F, -.1F, .7F, 0F, -.1F, .7F, 0F, -.1F, .1F); // Box 9
		gunModel[104].setRotationPoint(0F, 0F, 0F);

		gunModel[105].addShapeBox(12F, -10.3F, -0.5F, 1, 1, 1, 0F, 0F, -.1F, .1F, 0F, -.1F, .1F, 0F, -.1F, .1F, 0F, -.1F, .1F, 0F, -.1F, .7F, 0F, -.1F, .7F, 0F, -.1F, .7F, 0F, -.1F, .7F); // Box 10
		gunModel[105].setRotationPoint(0F, 0F, 0F);

		gunModel[106].addShapeBox(12F, -9.5F, -0.5F, 1, 1, 1, 0F, 0F, -.1F, .7F, 0F, -.1F, .7F, 0F, -.1F, .7F, 0F, -.1F, .7F, 0F, -.1F, .7F, 0F, -.1F, .7F, 0F, -.1F, .7F, 0F, -.1F, .7F); // Box 11
		gunModel[106].setRotationPoint(0F, 0F, 0F);

		gunModel[107].addShapeBox(12F, -8.7F, -0.5F, 1, 1, 1, 0F, 0F, -.1F, .7F, 0F, -.1F, .7F, 0F, -.1F, .7F, 0F, -.1F, .7F, 0F, -.1F, .1F, 0F, -.1F, .1F, 0F, -.1F, .1F, 0F, -.1F, .1F); // Box 12
		gunModel[107].setRotationPoint(0F, 0F, 0F);

		gunModel[108].addShapeBox(7.5F, -8.15F, -1F, 1, 1, 2, 0F, -.3F, -.3F, .1F, -.3F, -.3F, .1F, -.3F, -.3F, .1F, -.3F, -.3F, .1F, -.3F, -.3F, .1F, -.3F, -.3F, .1F, -.3F, -.3F, .1F, -.3F, -.3F, .1F); // Box 13
		gunModel[108].setRotationPoint(0F, 0F, 0F);

		gunModel[109].addShapeBox(3.5F, -8.15F, -1F, 1, 1, 2, 0F, -.3F, -.3F, .1F, -.3F, -.3F, .1F, -.3F, -.3F, .1F, -.3F, -.3F, .1F, -.3F, -.3F, .1F, -.3F, -.3F, .1F, -.3F, -.3F, .1F, -.3F, -.3F, .1F); // Box 14
		gunModel[109].setRotationPoint(0F, 0F, 0F);

		gunModel[110].addShapeBox(2F, -8.9F, -1F, 1, 1, 2, 0F, -.15F, -.15F, .15F, -.15F, -.15F, .15F, -.15F, -.15F, .15F, -.15F, -.15F, .15F, -.15F, -.15F, .15F, -.15F, -.15F, .15F, -.15F, -.15F, .15F, -.15F, -.15F, .15F); // Box 15
		gunModel[110].setRotationPoint(0F, 0F, 0F);

		gunModel[111].addShapeBox(6F, -9.9F, -1.2F, 1, 2, 1, 0F, -.15F, -.15F, .15F, -.15F, -.15F, .15F, -.15F, -.15F, .15F, -.15F, -.15F, .15F, -.15F, -.15F, .15F, -.15F, -.15F, .15F, -.15F, -.15F, .15F, -.15F, -.15F, .15F); // Box 16
