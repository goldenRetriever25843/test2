...
public class ModelNewSV98 extends ModelGun //Same as Filename
{
	int textureX = 512;
	int textureY = 512;

	public ModelNewSV98() //Same as Filename
	{
		...
		ammoModel[0] = new ModelRendererTurbo(this, 193, 1, textureX, textureY); // Box 0

		ammoModel[0].addShapeBox(0F, 0F, 0F, 8, 1, 1, 0F, 0F, 0.1F, -0.3F, -4F, 0.1F, -0.3F, -4F, 0.1F, -0.3F, 0F, 0.1F, -0.3F, 0F, 0F, -0.3F, -4F, -1F, -0.3F, -4F, -1F, -0.3F, 0F, 0F, -0.3F); // Box 0
		ammoModel[0].setRotationPoint(0.4F, -1.4F, -0.5F);


		slideModel = new ModelRendererTurbo[1];
		slideModel[0] = new ModelRendererTurbo(this, 89, 9, textureX, textureY); // Box 49

		slideModel[0].addShapeBox(0F, 0F, 0F, 1, 1, 2, 0F, -0.3F, -0.3F, 0F, -0.3F, -0.3F, 0F, -0.3F, -0.3F, 0F, -0.3F, -0.3F, 0F, -0.3F, -0.3F, 0F, -0.3F, -0.3F, 0F, -0.3F, -0.3F, 0F, -0.3F, -0.3F, 0F); // Box 49
		slideModel[0].setRotationPoint(0.8F, -4.2F, -1.5F);
		slideModel[0].rotateAngleX = 0.31415927F;
