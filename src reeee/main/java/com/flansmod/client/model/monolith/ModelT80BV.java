...
public class ModelT80BV extends ModelVehicle
{
	int textureX = 1024;
	int textureY = 1024;
	...
	public ModelT80BV()
	{
		...
		bodyModel[21].setRotationPoint(48F, -13F, -15F);

		bodyModel[22].addBox(0F, 0F, 0F, 1, 5, 3, 0F); // Import CR.RightLight
		bodyModel[22].setRotationPoint(48F, -13F, 12F);
		...
		bodyModel[26].addBox(14.9F, -0.8F, 0F, 4, 1, 2, 0F); // Import CR.LowerReactiveArmor
		bodyModel[26].setRotationPoint(34F, -15F, -9.6F);
		...
		bodyModel[42].addBox(14.9F, -0.8F, 0F, 4, 1, 2, 0F); // Box 202
		bodyModel[42].setRotationPoint(34F, -15F, -7.4F);
		bodyModel[42].rotateAngleZ = -0.40142573F;

		bodyModel[43].addBox(14.9F, -0.8F, 0F, 4, 1, 2, 0F); // Box 203
		bodyModel[43].setRotationPoint(34F, -15F, -5.2F);
		bodyModel[43].rotateAngleZ = -0.40142573F;

		bodyModel[44].addBox(14.9F, -0.8F, 0F, 4, 1, 2, 0F); // Box 204
		bodyModel[44].setRotationPoint(34F, -15F, -3F);
		bodyModel[44].rotateAngleZ = -0.40142573F;

		bodyModel[45].addBox(14.9F, -0.8F, 0F, 4, 1, 2, 0F); // Box 205
		bodyModel[45].setRotationPoint(34F, -15F, -0.8F);
		bodyModel[45].rotateAngleZ = -0.40142573F;

		bodyModel[46].addBox(14.9F, -0.8F, 0F, 4, 1, 2, 0F); // Box 206
		bodyModel[46].setRotationPoint(34F, -15F, 1.4F);
		bodyModel[46].rotateAngleZ = -0.40142573F;

		bodyModel[47].addBox(14.9F, -0.8F, 0F, 4, 1, 2, 0F); // Box 207
		bodyModel[47].setRotationPoint(34F, -15F, 5.8F);
		bodyModel[47].rotateAngleZ = -0.40142573F;

		bodyModel[48].addBox(14.9F, -0.8F, 0F, 4, 1, 2, 0F); // Box 208
		bodyModel[48].setRotationPoint(34F, -15F, 8F);
		bodyModel[48].rotateAngleZ = -0.40142573F;

		bodyModel[49].addBox(14.9F, -0.8F, 0F, 4, 1, 2, 0F); // Box 209
		bodyModel[49].setRotationPoint(34F, -15F, 3.6F);
		bodyModel[49].rotateAngleZ = -0.40142573F;

		bodyModel[50].addBox(10.5F, -0.8F, 0F, 4, 1, 2, 0F); // Box 229
		bodyModel[50].setRotationPoint(34F, -15F, -9.6F);
		bodyModel[50].rotateAngleZ = -0.40142573F;

		bodyModel[51].addBox(10.5F, -0.8F, 0F, 4, 1, 2, 0F); // Box 230
		bodyModel[51].setRotationPoint(34F, -15F, -7.4F);
		bodyModel[51].rotateAngleZ = -0.40142573F;

		bodyModel[52].addBox(10.5F, -0.8F, 0F, 4, 1, 2, 0F); // Box 231
		bodyModel[52].setRotationPoint(34F, -15F, -5.2F);
		bodyModel[52].rotateAngleZ = -0.40142573F;

		bodyModel[53].addBox(10.5F, -0.8F, 0F, 4, 1, 2, 0F); // Box 232
		bodyModel[53].setRotationPoint(34F, -15F, -3F);
		bodyModel[53].rotateAngleZ = -0.40142573F;

		bodyModel[54].addBox(10.5F, -0.8F, 0F, 4, 1, 2, 0F); // Box 233
		bodyModel[54].setRotationPoint(34F, -15F, -0.8F);
		bodyModel[54].rotateAngleZ = -0.40142573F;

		bodyModel[55].addBox(10.5F, -0.8F, 0F, 4, 1, 2, 0F); // Box 234
		bodyModel[55].setRotationPoint(34F, -15F, 1.4F);
		bodyModel[55].rotateAngleZ = -0.40142573F;

		bodyModel[56].addBox(10.5F, -0.8F, 0F, 4, 1, 2, 0F); // Box 235
		bodyModel[56].setRotationPoint(34F, -15F, 3.6F);
		bodyModel[56].rotateAngleZ = -0.40142573F;

		bodyModel[57].addBox(10.5F, -0.8F, 0F, 4, 1, 2, 0F); // Box 236
		bodyModel[57].setRotationPoint(34F, -15F, 5.8F);
		bodyModel[57].rotateAngleZ = -0.40142573F;

		bodyModel[58].addBox(10.5F, -0.8F, 0F, 4, 1, 2, 0F); // Box 237
		bodyModel[58].setRotationPoint(34F, -15F, 8F);
		bodyModel[58].rotateAngleZ = -0.40142573F;

		bodyModel[59].addBox(10.5F, -0.8F, 0F, 4, 1, 2, 0F); // Box 238
		bodyModel[59].setRotationPoint(34F, -15F, 12.5F);
		bodyModel[59].rotateAngleZ = -0.40142573F;

		bodyModel[60].addBox(10.5F, -0.8F, 0F, 4, 1, 2, 0F); // Box 240
		bodyModel[60].setRotationPoint(34F, -15F, 10.3F);
		bodyModel[60].rotateAngleZ = -0.40142573F;

		bodyModel[61].addBox(10.5F, -0.8F, 0F, 4, 1, 2, 0F); // Box 242
		bodyModel[61].setRotationPoint(34F, -15F, -11.9F);
		bodyModel[61].rotateAngleZ = -0.40142573F;

		bodyModel[62].addBox(10.5F, -0.8F, 0F, 4, 1, 2, 0F); // Box 243
		bodyModel[62].setRotationPoint(34F, -15F, -14.1F);
		bodyModel[62].rotateAngleZ = -0.40142573F;

		bodyModel[63].addBox(6.1F, -0.8F, 0F, 4, 1, 2, 0F); // Box 244
		bodyModel[63].setRotationPoint(34F, -15F, -16.3F);
		bodyModel[63].rotateAngleZ = -0.40142573F;

		bodyModel[64].addBox(6.1F, -0.8F, 0F, 4, 1, 2, 0F); // Box 245
		bodyModel[64].setRotationPoint(34F, -15F, -14.1F);
		bodyModel[64].rotateAngleZ = -0.40142573F;

		bodyModel[65].addBox(6.1F, -0.8F, 0F, 4, 1, 2, 0F); // Box 246
		bodyModel[65].setRotationPoint(34F, -15F, -11.9F);
		bodyModel[65].rotateAngleZ = -0.40142573F;

		bodyModel[66].addBox(6.1F, -0.8F, 0F, 4, 1, 2, 0F); // Box 247
		bodyModel[66].setRotationPoint(34F, -15F, -9.6F);
		bodyModel[66].rotateAngleZ = -0.40142573F;

		bodyModel[67].addBox(6.1F, -0.8F, 0F, 4, 1, 2, 0F); // Box 248
		bodyModel[67].setRotationPoint(34F, -15F, -7.4F);
		bodyModel[67].rotateAngleZ = -0.40142573F;

		bodyModel[68].addBox(6.1F, -0.8F, 0F, 4, 1, 2, 0F); // Box 249
		bodyModel[68].setRotationPoint(34F, -15F, -5.2F);
		bodyModel[68].rotateAngleZ = -0.40142573F;

		bodyModel[69].addBox(6.1F, -0.8F, 0F, 4, 1, 2, 0F); // Box 250
		bodyModel[69].setRotationPoint(34F, -15F, -3F);
		bodyModel[69].rotateAngleZ = -0.40142573F;

		bodyModel[70].addBox(6.1F, -0.8F, 0F, 4, 1, 2, 0F); // Box 251
		bodyModel[70].setRotationPoint(34F, -15F, -0.8F);
		bodyModel[70].rotateAngleZ = -0.40142573F;

		bodyModel[71].addBox(6.1F, -0.8F, 0F, 4, 1, 2, 0F); // Box 252
		bodyModel[71].setRotationPoint(34F, -15F, 1.4F);
		bodyModel[71].rotateAngleZ = -0.40142573F;

		bodyModel[72].addBox(6.1F, -0.8F, 0F, 4, 1, 2, 0F); // Box 253
		bodyModel[72].setRotationPoint(34F, -15F, 3.6F);
		bodyModel[72].rotateAngleZ = -0.40142573F;

		bodyModel[73].addBox(6.1F, -0.8F, 0F, 4, 1, 2, 0F); // Box 254
		bodyModel[73].setRotationPoint(34F, -15F, 5.8F);
		bodyModel[73].rotateAngleZ = -0.40142573F;

		bodyModel[74].addBox(6.1F, -0.8F, 0F, 4, 1, 2, 0F); // Box 255
		bodyModel[74].setRotationPoint(34F, -15F, 8F);
		bodyModel[74].rotateAngleZ = -0.40142573F;

		bodyModel[75].addBox(6.1F, -0.8F, 0F, 4, 1, 2, 0F); // Box 256
		bodyModel[75].setRotationPoint(34F, -15F, 10.3F);
		bodyModel[75].rotateAngleZ = -0.40142573F;

		bodyModel[76].addBox(6.1F, -0.8F, 0F, 4, 1, 2, 0F); // Box 257
		bodyModel[76].setRotationPoint(34F, -15F, 12.5F);
		bodyModel[76].rotateAngleZ = -0.40142573F;

		bodyModel[77].addBox(6.1F, -0.8F, 0F, 4, 1, 2, 0F); // Box 258
		bodyModel[77].setRotationPoint(34F, -15F, 14.7F);
		bodyModel[77].rotateAngleZ = -0.40142573F;

		bodyModel[78].addBox(1.7F, -0.8F, 0F, 4, 1, 2, 0F); // Box 259
		bodyModel[78].setRotationPoint(34F, -15F, 14.7F);
		bodyModel[78].rotateAngleZ = -0.40142573F;

		bodyModel[79].addBox(1.7F, -0.8F, 0F, 4, 1, 2, 0F); // Box 260
		bodyModel[79].setRotationPoint(34F, -15F, 12.5F);
		bodyModel[79].rotateAngleZ = -0.40142573F;

		bodyModel[80].addBox(1.7F, -0.8F, 0F, 4, 1, 2, 0F); // Box 261
		bodyModel[80].setRotationPoint(34F, -15F, 10.3F);
		bodyModel[80].rotateAngleZ = -0.40142573F;

		bodyModel[81].addBox(1.7F, -0.8F, 0F, 4, 1, 2, 0F); // Box 262
		bodyModel[81].setRotationPoint(34F, -15F, -11.9F);
		bodyModel[81].rotateAngleZ = -0.40142573F;

		bodyModel[82].addBox(1.7F, -0.8F, 0F, 4, 1, 2, 0F); // Box 263
		bodyModel[82].setRotationPoint(34F, -15F, -14.1F);
		bodyModel[82].rotateAngleZ = -0.40142573F;

		bodyModel[83].addBox(1.7F, -0.8F, 0F, 4, 1, 2, 0F); // Box 264
		bodyModel[83].setRotationPoint(34F, -15F, -16.3F);
		...
		turretModel[9].addShapeBox(-10F, 0F, 2F, 0, 60, 0, 0F,0F, 0F, 0F,0F, 0F, 0F,0F, 0F, 0F,0F, 0F, 0F,1F, 0F, 1F,1F, 0F, 1F,1F, 0F, 1F,1F, 0F, 1F); // Import Shape1
		...
		turretModel[100].addShapeBox(0F, 0F, -4.5F, 1, 3, 0, 0F,0F, 2F, 0F,0F, 2F, 0F,0F, 2F, 1F,0F, 2F, 1F,0F, 0F, 0F,0F, 0F, 0F,0F, 0F, 2F,0F, 0F, 2F); // Box 275
		turretModel[100].setRotationPoint(0F, -38F, 0F);

		turretModel[101].addShapeBox(0F, 0F, -9.5F, 1, 3, 0, 0F,0F, 2F, 1F,0F, 2F, 1F,0F, 2F, 0F,0F, 2F, 0F,0F, 0F, 2F,0F, 0F, 2F,0F, 0F, 0F,0F, 0F, 0F); // Box 278
