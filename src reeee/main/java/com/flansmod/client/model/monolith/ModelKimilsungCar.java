...
public class ModelKimilsungCar extends ModelVehicle //Same as Filename
{
	int textureX = 1024;
	int textureY = 1024;

	public ModelKimilsungCar() //Same as Filename
	{
		...
		bodyModel[13].setRotationPoint(41F, -132F, -46F);
		bodyModel[13].rotateAngleX = 2.21656815F;
		bodyModel[13].rotateAngleY = -1.71042267F;
		bodyModel[13].rotateAngleZ = 0.10471976F;
		...
		bodyModel[14].setRotationPoint(41F, -132F, -46F);
		bodyModel[14].rotateAngleX = 2.21656815F;
		bodyModel[14].rotateAngleY = -1.71042267F;
		bodyModel[14].rotateAngleZ = 0.10471976F;
		...
		bodyModel[15].setRotationPoint(40F, -135F, -50F);
		bodyModel[15].rotateAngleX = 2.21656815F;
		bodyModel[15].rotateAngleY = -2.23402144F;
		bodyModel[15].rotateAngleZ = 0.50614548F;
		...
		leftFrontWheelModel[0] = new ModelRendererTurbo(this, 673, 1, textureX, textureY); // Box 21
		leftFrontWheelModel[1] = new ModelRendererTurbo(this, 673, 1, textureX, textureY); // Box 22
		leftFrontWheelModel[2] = new ModelRendererTurbo(this, 673, 1, textureX, textureY); // Box 23

		leftFrontWheelModel[0].addShapeBox(-11F, -4F, -4F, 22, 8, 9, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 21
		leftFrontWheelModel[0].setRotationPoint(7F, 14F, 42F);
		leftFrontWheelModel[0].rotateAngleY = -0.06981317F;

		leftFrontWheelModel[1].addShapeBox(-11F, 4F, -4F, 22, 7, 9, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -5F, 0F, 0F, -5F, 0F, 0F, -5F, 0F, 0F, -5F, 0F, 0F); // Box 22
		leftFrontWheelModel[1].setRotationPoint(7F, 14F, 42F);
		leftFrontWheelModel[1].rotateAngleY = -0.06981317F;

		leftFrontWheelModel[2].addShapeBox(-11F, -11F, -4F, 22, 7, 9, 0F, -5F, 0F, 0F, -5F, 0F, 0F, -5F, 0F, 0F, -5F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 23
		leftFrontWheelModel[2].setRotationPoint(7F, 14F, 42F);
		leftFrontWheelModel[2].rotateAngleY = -0.06981317F;


		rightFrontWheelModel = new ModelRendererTurbo[3];
		rightFrontWheelModel[0] = new ModelRendererTurbo(this, 673, 1, textureX, textureY); // Box 18
		rightFrontWheelModel[1] = new ModelRendererTurbo(this, 673, 1, textureX, textureY); // Box 19
		rightFrontWheelModel[2] = new ModelRendererTurbo(this, 673, 1, textureX, textureY); // Box 20

		rightFrontWheelModel[0].addShapeBox(-11F, -4F, -5F, 22, 8, 9, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 18
		rightFrontWheelModel[0].setRotationPoint(1F, 14F, -36F);
		rightFrontWheelModel[0].rotateAngleY = -0.06981317F;

		rightFrontWheelModel[1].addShapeBox(-11F, 4F, -5F, 22, 7, 9, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -5F, 0F, 0F, -5F, 0F, 0F, -5F, 0F, 0F, -5F, 0F, 0F); // Box 19
		rightFrontWheelModel[1].setRotationPoint(1F, 14F, -36F);
		rightFrontWheelModel[1].rotateAngleY = -0.06981317F;

		rightFrontWheelModel[2].addShapeBox(-11F, -11F, -5F, 22, 7, 9, 0F, -5F, 0F, 0F, -5F, 0F, 0F, -5F, 0F, 0F, -5F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 20
		rightFrontWheelModel[2].setRotationPoint(1F, 14F, -36F);
		rightFrontWheelModel[2].rotateAngleY = -0.06981317F;
