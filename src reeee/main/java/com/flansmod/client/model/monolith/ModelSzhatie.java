...
public class ModelSzhatie extends ModelVehicle
{
	int textureX = 1024;
	int textureY = 1024;
...
// Body
		...
		bodyModel[37] = new ModelRendererTurbo(this,  420,  880, textureX, textureY); // CR.Teeth
		bodyModel[38] = new ModelRendererTurbo(this,  430,  800, textureX, textureY); // CR.DriverThingy
		bodyModel[39] = new ModelRendererTurbo(this,  430,  750, textureX, textureY); // CR.Axis
		...
		bodyModel[37].addBox(-2.7F, 0F, 0F, 1, 4, 32, 0F); // CR.Teeth
		bodyModel[37].setRotationPoint(55F, -1F, -16F);
		bodyModel[37].rotateAngleZ = -0.6632251F;

		bodyModel[38].addBox(0F, 0F, 0F, 5, 3, 10, 0F); // CR.DriverThingy
		bodyModel[38].setRotationPoint(34F, -15.8F, -5F);

		bodyModel[39].addBox(0F, 0F, 0F, 30, 4, 30, 0F); // CR.Axis
		bodyModel[39].setRotationPoint(-15F, -18F, -15F);
...
// Turret
		...
		turretModel[19] = new ModelRendererTurbo(this,  800,  500, textureX, textureY); // TR.Antenna
		turretModel[20] = new ModelRendererTurbo(this,  800,  550, textureX, textureY); // TR.Camera
		turretModel[21] = new ModelRendererTurbo(this,  800,  600, textureX, textureY); // TR.Hatch
		turretModel[22] = new ModelRendererTurbo(this,  880,  600, textureX, textureY); // TR.MGHolder
		turretModel[23] = new ModelRendererTurbo(this,  200,  0, textureX, textureY); // TR.LaserBase
		turretModel[24] = new ModelRendererTurbo(this,  300,  0, textureX, textureY); // TR.LaserBody
		turretModel[25] = new ModelRendererTurbo(this,  0,  0, textureX, textureY); // TR.UnderLaserBody
		turretModel[26] = new ModelRendererTurbo(this,  500,  0, textureX, textureY); // TR.CoverTop
		turretModel[27] = new ModelRendererTurbo(this,  500,  80, textureX, textureY); // TR.CoverBottom
		turretModel[28] = new ModelRendererTurbo(this,  400,  0, textureX, textureY); // TR.CoverLeft
		turretModel[29] = new ModelRendererTurbo(this,  400,  0, textureX, textureY); // TR.CoverRight
		...
		turretModel[5].addBox(19.2F, 0F, -19F, 7, 15, 19, 0F); // TR.LeftFrontSide
		turretModel[5].setRotationPoint(0F, -22.5F, 0F);
		turretModel[5].rotateAngleZ = 0.4363323F;

		turretModel[6].addBox(19.2F, 0F, 0F, 7, 15, 19, 0F); // TR.RightFrontSide
		...
		turretModel[8].addBox(19.2F, -9F, 0F, 7, 9, 14, 0F); // TR.RightTopFrontSide
		turretModel[8].setRotationPoint(0F, -22.5F, 0F);
		turretModel[8].rotateAngleZ = 0.4363323F;

		turretModel[9].addBox(-25F, 6F, -13F, 46, 10, 5, 0F); // TR.LeftUpperCheeck
		turretModel[9].setRotationPoint(-2F, -41F, 0F);
		turretModel[9].rotateAngleX = -0.4886922F;

		turretModel[10].addBox(-27F, 6F, 8.5F, 46, 10, 5, 0F); // TR.RightUpperCheeck
		...
		turretModel[12].addBox(19.2F, -9F, -14F, 7, 9, 14, 0F); // TR.LeftTopFrontSide
		turretModel[12].setRotationPoint(0F, -22.5F, 0F);
		turretModel[12].rotateAngleZ = 0.4363323F;

		turretModel[13].addBox(-26F, 0F, -14.5F, 45, 9, 29, 0F); // TR.Roof
		turretModel[13].setRotationPoint(0F, -42F, 0F);

		turretModel[14].addBox(-34F, 0F, 0F, 3, 16, 19, 0F); // TR.RightBack
		turretModel[14].setRotationPoint(0F, -33.5F, 0F);

		turretModel[15].addBox(-34F, 0F, -19F, 3, 16, 19, 0F); // TR.LeftBack
		turretModel[15].setRotationPoint(0F, -33.5F, 0F);

		turretModel[16].addBox(-36F, 0F, -14.5F, 5, 11, 29, 0F); // TR.BackCenterangle
		turretModel[16].setRotationPoint(0F, -17.5F, 0F);
		turretModel[16].rotateAngleZ = -0.7330383F;

		turretModel[17].addBox(-29F, 7F, 17F, 5, 10, 6, 0F); // TR.BackRightTopCorner
		...
		turretModel[18].addBox(-41F, -8F, -32F, 5, 10, 6, 0F); // TR.BackLeftTopCorner
		...
		turretModel[19].addBox(-12F, 0F, -10F, 1, 30, 1, 0F); // TR.Antenna
		turretModel[19].setRotationPoint(0F, -70F, 0F);

		turretModel[20].addBox(9F, 0F, 8F, 8, 4, 4, 0F); // TR.Camera
		turretModel[20].setRotationPoint(0F, -46F, 0F);

		turretModel[21].addBox(6F, 0F, -13F, 10, 1, 10, 0F); // TR.Hatch
		turretModel[21].setRotationPoint(0F, -43F, 0F);

		turretModel[22].addBox(16F, 0F, -8.5F, 1, 4, 1, 0F); // TR.MGHolder
		turretModel[22].setRotationPoint(0F, -50F, 0F);
		turretModel[22].rotateAngleZ = -0.3141593F;

		turretModel[23].addBox(20F, 0F, -14F, 14, 14, 28, 0F); // TR.LaserBase
		turretModel[23].setRotationPoint(0F, -39F, 0F);

		turretModel[24].addBox(34F, 0F, -16F, 10, 15, 32, 0F); // TR.LaserBody
		turretModel[24].setRotationPoint(0F, -40F, 0F);

		turretModel[25].addBox(34F, 0F, -16F, 10, 2, 32, 0F); // TR.UnderLaserBody
		turretModel[25].setRotationPoint(0F, -21F, 0F);
		turretModel[25].rotateAngleZ = 0.1396263F;

		turretModel[26].addBox(44F, 0F, -14.5F, 5, 0, 29, 0F); // TR.CoverTop
		turretModel[26].setRotationPoint(0F, -38F, 0F);

		turretModel[27].addBox(44F, 0F, -14.5F, 3, 0, 29, 0F); // TR.CoverBottom
		turretModel[27].setRotationPoint(0F, -27F, 0F);

		turretModel[28].addBox(44F, 0F, -14.5F, 5, 12, 0, 0F); // TR.CoverLeft
		turretModel[28].setRotationPoint(0F, -41.5F, 0F);
		turretModel[28].rotateAngleZ = -0.06981317F;

		turretModel[29].addBox(44F, 0F, 14.5F, 5, 12, 0, 0F); // TR.CoverRight
		turretModel[29].setRotationPoint(0F, -41.5F, 0F);
...
// Barrel
		...
		barrelModel[5] = new ModelRendererTurbo(this,  650,  0, textureX, textureY); // BL.Lense1
		barrelModel[6] = new ModelRendererTurbo(this,  650,  0, textureX, textureY); // BL.Lense2
		barrelModel[7] = new ModelRendererTurbo(this,  650,  0, textureX, textureY); // BL.Lense3
		barrelModel[8] = new ModelRendererTurbo(this,  650,  0, textureX, textureY); // BL.Lense6
		barrelModel[9] = new ModelRendererTurbo(this,  650,  0, textureX, textureY); // BL.Lense5
		barrelModel[10] = new ModelRendererTurbo(this,  650,  0, textureX, textureY); // BL.Lense4
		barrelModel[11] = new ModelRendererTurbo(this,  650,  0, textureX, textureY); // BL.Lense1bottom
		barrelModel[12] = new ModelRendererTurbo(this,  650,  0, textureX, textureY); // BL.Lense2bottom
		barrelModel[13] = new ModelRendererTurbo(this,  650,  0, textureX, textureY); // BL.Lense3bottom
		barrelModel[14] = new ModelRendererTurbo(this,  650,  0, textureX, textureY); // BL.Lense4bottom
		barrelModel[15] = new ModelRendererTurbo(this,  650,  0, textureX, textureY); // BL.Lense5bottom
		barrelModel[16] = new ModelRendererTurbo(this,  650,  0, textureX, textureY); // BL.Lense6bottom
		...
		barrelModel[5].addBox(0F, -1.5F, -1.5F, 1, 3, 3, 0F); // BL.Lense1
		barrelModel[5].setRotationPoint(44F, -35.5F, 12F);

		barrelModel[6].addBox(0F, -1.5F, -1.5F, 1, 3, 3, 0F); // BL.Lense2
		barrelModel[6].setRotationPoint(44F, -35.5F, 7.5F);

		barrelModel[7].addBox(0F, -1.5F, -1.5F, 1, 3, 3, 0F); // BL.Lense3
		barrelModel[7].setRotationPoint(44F, -35.5F, 3F);

		barrelModel[8].addBox(0F, -1.5F, -1.5F, 1, 3, 3, 0F); // BL.Lense6
		barrelModel[8].setRotationPoint(44F, -35.5F, -12F);

		barrelModel[9].addBox(0F, -1.5F, -1.5F, 1, 3, 3, 0F); // BL.Lense5
		barrelModel[9].setRotationPoint(44F, -35.5F, -7.5F);

		barrelModel[10].addBox(0F, -1.5F, -1.5F, 1, 3, 3, 0F); // BL.Lense4
		barrelModel[10].setRotationPoint(44F, -35.5F, -3F);

		barrelModel[11].addBox(0F, -1.5F, -1.5F, 1, 3, 3, 0F); // BL.Lense1bottom
		barrelModel[11].setRotationPoint(44F, -29.5F, 12F);

		barrelModel[12].addBox(0F, -1.5F, -1.5F, 1, 3, 3, 0F); // BL.Lense2bottom
		barrelModel[12].setRotationPoint(44F, -29.5F, 7.5F);

		barrelModel[13].addBox(0F, -1.5F, -1.5F, 1, 3, 3, 0F); // BL.Lense3bottom
		barrelModel[13].setRotationPoint(44F, -29.5F, 3F);

		barrelModel[14].addBox(0F, -1.5F, -1.5F, 1, 3, 3, 0F); // BL.Lense4bottom
		barrelModel[14].setRotationPoint(44F, -29.5F, -3F);

		barrelModel[15].addBox(0F, -1.5F, -1.5F, 1, 3, 3, 0F); // BL.Lense5bottom
		barrelModel[15].setRotationPoint(44F, -29.5F, -7.5F);

		barrelModel[16].addBox(0F, -1.5F, -1.5F, 1, 3, 3, 0F); // BL.Lense6bottom
		barrelModel[16].setRotationPoint(44F, -29.5F, -12F);
