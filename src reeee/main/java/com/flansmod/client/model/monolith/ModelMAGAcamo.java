...
public class ModelMAGAcamo extends ModelCustomArmour //Same as Filename
{
	int textureX = 2048;
	int textureY = 2048;

	public ModelMAGAcamo() //Same as Filename
	{
	...
	{
		headModel[0] = new ModelRendererTurbo(this, 1, 1, textureX, textureY); // Import Box1
		headModel[1] = new ModelRendererTurbo(this, 169, 1, textureX, textureY); // Import Box3
		headModel[2] = new ModelRendererTurbo(this, 337, 1, textureX, textureY); // Import Box11
		headModel[3] = new ModelRendererTurbo(this, 945, 1, textureX, textureY); // Box 0
		...
		headModel[6] = new ModelRendererTurbo(this, 1329, 1, textureX, textureY); // Box 6
		...
		headModel[2].addShapeBox(-150.5F, -57.1F, -5.1F, 301, 100, 1, 0F,-147.8F, -51.2F, -0.3F, -147.8F, -51.2F, -0.3F, -147.8F, -51.2F, 0F, -147.8F, -51.2F, 0F, -147.8F, -51.2F, -0.7F, -147.8F, -51.2F, -0.7F, -147.8F, -51.2F, 0F, -147.8F, -51.2F, 0F); // Import Box11
