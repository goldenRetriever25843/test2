...
public class ModelMaid extends ModelCustomArmour
{
	int textureX = 512;
	int textureY = 512;
	...
	public ModelMaid()
	{
		...
		bodyModel[9] = new ModelRendererTurbo(this, 0, 300, textureX, textureY); // Lower Dress
		...
		bodyModel[9].addBox(-5F, 7.45F, -3.5F, 10, 3, 5, 0F); // Lower Dress
		...
		rightArmModel[0].addBox(-4.5F, 1F, -1F, 2, 6, 3, 0F); // Top
		rightArmModel[0].setRotationPoint(0F, 0F, 0F);
		rightArmModel[0].rotateAngleX = 0.10471976F;
		rightArmModel[0].rotateAngleZ = -0.34906585F;

		rightArmModel[1].addBox(-4.7F, 6.5F, -0.3F, 2, 6, 3, 0F); // Bottom
		rightArmModel[1].setRotationPoint(0F, 0F, 0F);
		rightArmModel[1].rotateAngleZ = -0.31415927F;

		rightArmModel[2].addBox(-4.75F, 0.9F, -1.5F, 3, 7, 4, 0F); // Right Sleeve
		rightArmModel[2].setRotationPoint(0F, 0F, 0F);
		rightArmModel[2].rotateAngleX = 0.10471976F;
		rightArmModel[2].rotateAngleZ = -0.34906585F;

		rightArmModel[3].addBox(-5.2F, 6.5F, -0.8F, 3, 5, 4, 0F); // Lower Right sleeve
		rightArmModel[3].setRotationPoint(0F, 0F, 0F);
		rightArmModel[3].rotateAngleZ = -0.31415927F;


		leftLegModel = new ModelRendererTurbo[5];
		leftLegModel[0] = new ModelRendererTurbo(this, 0, 80, textureX, textureY); // Thigh
		leftLegModel[1] = new ModelRendererTurbo(this, 0, 120, textureX, textureY); // Femur
		leftLegModel[2] = new ModelRendererTurbo(this, 100, 300, textureX, textureY); // Left Dress Thigh
		leftLegModel[3] = new ModelRendererTurbo(this, 200, 300, textureX, textureY); // Left Lower Dress
		leftLegModel[4] = new ModelRendererTurbo(this, 300, 300, textureX, textureY); // Box 29

		leftLegModel[0].addBox(1F, 9.5F, -1.3F, 3, 6, 4, 0F); // Thigh
		leftLegModel[0].setRotationPoint(0F, 0F, 0F);
		leftLegModel[0].rotateAngleX = -0.06981317F;
		leftLegModel[0].rotateAngleY = 0.17453293F;
		leftLegModel[0].rotateAngleZ = -0.05235988F;

		leftLegModel[1].addBox(0.4F, 15F, -2.6F, 3, 9, 3, 0F); // Femur
		leftLegModel[1].setRotationPoint(0F, 0F, 0F);
		leftLegModel[1].rotateAngleX = 0.05235988F;

		leftLegModel[2].addBox(-2F, 8.5F, -3F, 7, 6, 6, 0F); // Left Dress Thigh
		leftLegModel[2].setRotationPoint(0F, 0F, 0F);
		leftLegModel[2].rotateAngleX = -0.03490659F;
		leftLegModel[2].rotateAngleY = 0.08726646F;
		leftLegModel[2].rotateAngleZ = 0.03490659F;

		leftLegModel[3].addShapeBox(-0.4F, 13.8F, -6F, 6, 9, 7, 0F,0F, 0F, 0F,0F, 0F, 0F,0F, 0F, 0F,0F, 0F, 0F,0F, 0F, 0F,0F, 0F, 0F,0F, 0F, 0F,0F, 0F, 0F); // Left Lower Dress
		leftLegModel[3].setRotationPoint(0F, 0F, 0F);
		leftLegModel[3].rotateAngleX = 0.13962634F;
		leftLegModel[3].rotateAngleY = 0.08726646F;

		leftLegModel[4].addShapeBox(-0.9F, 15F, -6.5F, 7, 8, 8, 0F,0F, 0F, 0F,0F, 0F, 0F,0F, 0F, 0F,0F, 0F, 0F,0F, 0F, 0F,0F, 0F, 0F,0F, 0F, 0F,0F, 0F, 0F); // Box 29
		leftLegModel[4].setRotationPoint(0F, 0F, 0F);
		leftLegModel[4].rotateAngleX = 0.13962634F;
		leftLegModel[4].rotateAngleY = 0.08726646F;


		rightLegModel = new ModelRendererTurbo[5];
		rightLegModel[0] = new ModelRendererTurbo(this, 0, 80, textureX, textureY); // Thigh
		rightLegModel[1] = new ModelRendererTurbo(this, 0, 120, textureX, textureY); // Femur
		rightLegModel[2] = new ModelRendererTurbo(this, 50, 300, textureX, textureY); // Right Dress thigh
		rightLegModel[3] = new ModelRendererTurbo(this, 150, 300, textureX, textureY); // Right Lower Dress
		rightLegModel[4] = new ModelRendererTurbo(this, 250, 300, textureX, textureY); // Outer Right Bottom Dress

		rightLegModel[0].addBox(-3F, 9.5F, -1.3F, 3, 6, 4, 0F); // Thigh
		rightLegModel[0].setRotationPoint(0F, 0F, 0F);
		rightLegModel[0].rotateAngleX = -0.06981317F;
		rightLegModel[0].rotateAngleY = -0.17453293F;
		rightLegModel[0].rotateAngleZ = -0.05235988F;

		rightLegModel[1].addBox(-3.4F, 15F, -2.6F, 3, 9, 3, 0F); // Femur
		rightLegModel[1].setRotationPoint(0F, 0F, 0F);
		rightLegModel[1].rotateAngleX = 0.05235988F;

		rightLegModel[2].addBox(-5F, 8.5F, -3F, 7, 6, 6, 0F); // Right Dress thigh
		rightLegModel[2].setRotationPoint(0F, 0F, 0F);
		rightLegModel[2].rotateAngleX = -0.03490659F;
		rightLegModel[2].rotateAngleY = -0.08726646F;
		rightLegModel[2].rotateAngleZ = -0.03490659F;

		rightLegModel[3].addShapeBox(-5.4F, 13.8F, -6F, 6, 9, 7, 0F,0F, 0F, 0F,0F, 0F, 0F,0F, 0F, 0F,0F, 0F, 0F,0F, 0F, 0F,0F, 0F, 0F,0F, 0F, 0F,0F, 0F, 0F); // Right Lower Dress
		rightLegModel[3].setRotationPoint(0F, 0F, 0F);
		rightLegModel[3].rotateAngleX = 0.13962634F;
		rightLegModel[3].rotateAngleY = -0.08726646F;

		rightLegModel[4].addShapeBox(-5.9F, 15F, -6.5F, 7, 8, 8, 0F,0F, 0F, 0F,0F, 0F, 0F,0F, 0F, 0F,0F, 0F, 0F,0F, 0F, 0F,0F, 0F, 0F,0F, 0F, 0F,0F, 0F, 0F); // Outer Right Bottom Dress
		rightLegModel[4].setRotationPoint(0F, 0F, 0F);
		rightLegModel[4].rotateAngleX = 0.13962634F;
		rightLegModel[4].rotateAngleY = -0.08726646F;
