...
public class ModelCrappyBike extends ModelVehicle //Same as Filename
{
	int textureX = 512;
	int textureY = 512;

	public ModelCrappyBike() //Same as Filename
	{
		...
		leftFrontWheelModel = new ModelRendererTurbo[12];
		...
		leftFrontWheelModel[9] = new ModelRendererTurbo(this, 345, 1, textureX, textureY); // Box 25
		leftFrontWheelModel[10] = new ModelRendererTurbo(this, 49, 1, textureX, textureY); // Box 26
		leftFrontWheelModel[11] = new ModelRendererTurbo(this, 353, 1, textureX, textureY); // Box 27

		leftFrontWheelModel[0].addShapeBox(0F, -5F, -0.5F, 1, 6, 1, 0F, 0.1F, 0F, 0.1F, 0.1F, 0F, 0.1F, 0.1F, 0F, 0.1F, 0.1F, 0F, 0.1F, 0.1F, 0F, 0.1F, 0.1F, 0F, 0.1F, 0.1F, 0F, 0.1F, 0.1F, 0F, 0.1F); // Box 16
		leftFrontWheelModel[0].setRotationPoint(9F, -5F, 0F);
		leftFrontWheelModel[0].rotateAngleZ = 0.2443461F;
		...
		leftFrontWheelModel[9].addShapeBox(0F, 1F, -0.5F, 1, 9, 1, 0F, 0.1F, 0F, 0.1F, 0.1F, 0F, 0.1F, 0.1F, 0F, 0.1F, 0.1F, 0F, 0.1F, 0.1F, 0F, 0.1F, 0.1F, 0F, 0.1F, 0.1F, 0F, 0.1F, 0.1F, 0F, 0.1F); // Box 25
		leftFrontWheelModel[9].setRotationPoint(9F, -5F, 0F);
		leftFrontWheelModel[9].rotateAngleZ = 0.2443461F;

		leftFrontWheelModel[10].addShapeBox(0F, -5F, -5.5F, 1, 1, 11, 0F, 0.1F, 0F, 0.1F, 0.1F, 0F, 0.1F, 0.1F, 0F, 0.1F, 0.1F, 0F, 0.1F, 0.1F, 0F, 0.1F, 0.1F, 0F, 0.1F, 0.1F, 0F, 0.1F, 0.1F, 0F, 0.1F); // Box 26
		leftFrontWheelModel[10].setRotationPoint(9F, -5F, 0F);
		leftFrontWheelModel[10].rotateAngleZ = 0.2443461F;

		leftFrontWheelModel[11].addShapeBox(1.2F, -4F, -0.5F, 1, 2, 1, 0F, 0.1F, 0F, 0.2F, 0.1F, 0F, 0.2F, 0.1F, 0F, 0.2F, 0.1F, 0F, 0.2F, 0.1F, 0F, 0.2F, 0.1F, 0F, 0.2F, 0.1F, 0F, 0.2F, 0.1F, 0F, 0.2F); // Box 27
		leftFrontWheelModel[11].setRotationPoint(9F, -5F, 0F);
		leftFrontWheelModel[11].rotateAngleZ = 0.2443461F;
