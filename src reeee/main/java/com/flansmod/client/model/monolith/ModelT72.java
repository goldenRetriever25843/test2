...
public class ModelT72 extends ModelVehicle
{
	int textureX = 1024;
	int textureY = 1024;
	...
	public ModelT72()
	{
		...
		bodyModel[49] = new ModelRendererTurbo(this, 35, 0, textureX, textureY); // Box 285
		bodyModel[50] = new ModelRendererTurbo(this, 0, 0, textureX, textureY); // Box 1
		bodyModel[51] = new ModelRendererTurbo(this, 0, 0, textureX, textureY); // Box 2
		bodyModel[52] = new ModelRendererTurbo(this, 0, 0, textureX, textureY); // Box 4
		bodyModel[53] = new ModelRendererTurbo(this, 0, 0, textureX, textureY); // Box 8
		bodyModel[54] = new ModelRendererTurbo(this, 0, 0, textureX, textureY); // Box 9
		bodyModel[55] = new ModelRendererTurbo(this, 0, 0, textureX, textureY); // Box 10
		bodyModel[56] = new ModelRendererTurbo(this, 0, 0, textureX, textureY); // Box 11
		bodyModel[57] = new ModelRendererTurbo(this, 0, 0, textureX, textureY); // Box 12
		bodyModel[58] = new ModelRendererTurbo(this, 0, 0, textureX, textureY); // Box 13
		...
		bodyModel[49].addBox(0F, -3F, 0F, 5, 2, 2, 0F); // Box 285
		bodyModel[49].setRotationPoint(-23F, -10.5F, -27F);
		bodyModel[49].rotateAngleX = 0.17453293F;

		bodyModel[50].addBox(0F, 0F, 0F, 7, 3, 12, 0F); // Box 1
		bodyModel[50].setRotationPoint(-52F, -18F, 1F);

		bodyModel[51].addShapeBox(0F, -1F, 0F, 3, 1, 12, 0F,0F, 1F, 0F,0F, 1F, 0F,0F, 1F, 0F,0F, 1F, 0F,2F, 0F, 0F,2F, 0F, 0F,2F, 0F, 0F,2F, 0F, 0F); // Box 2
		bodyModel[51].setRotationPoint(-50F, -18F, 1F);

		bodyModel[52].addShapeBox(0F, -1F, 0F, 3, 1, 12, 0F,2F, 0F, 0F,2F, 0F, 0F,2F, 0F, 0F,2F, 0F, 0F,0F, 1F, 0F,0F, 1F, 0F,0F, 1F, 0F,0F, 1F, 0F); // Box 4
		bodyModel[52].setRotationPoint(-50F, -14F, 1F);

		bodyModel[53].addBox(0F, -1F, 0F, 0, 0, 0, 0F); // Box 8
		bodyModel[53].setRotationPoint(0F, -8F, -12F);

		bodyModel[54].addBox(0F, 0F, 0F, 7, 3, 12, 0F); // Box 9
		bodyModel[54].setRotationPoint(-52F, -18F, -13F);

		bodyModel[55].addShapeBox(0F, -1F, 0F, 3, 1, 12, 0F,0F, 1F, 0F,0F, 1F, 0F,0F, 1F, 0F,0F, 1F, 0F,2F, 0F, 0F,2F, 0F, 0F,2F, 0F, 0F,2F, 0F, 0F); // Box 10
		bodyModel[55].setRotationPoint(-50F, -18F, -13F);

		bodyModel[56].addShapeBox(0F, -1F, 0F, 3, 1, 12, 0F,2F, 0F, 0F,2F, 0F, 0F,2F, 0F, 0F,2F, 0F, 0F,0F, 1F, 0F,0F, 1F, 0F,0F, 1F, 0F,0F, 1F, 0F); // Box 11
		bodyModel[56].setRotationPoint(-50F, -14F, -13F);

		bodyModel[57].addBox(0F, -2F, 1F, 8, 1, 8, 0F); // Box 12
		bodyModel[57].setRotationPoint(48F, -2F, -23.5F);
		bodyModel[57].rotateAngleX = -0.10471976F;
		bodyModel[57].rotateAngleY = 0.78539816F;
		bodyModel[57].rotateAngleZ = 0.05235988F;

		bodyModel[58].addBox(0F, -2F, 3F, 8, 1, 8, 0F); // Box 13
		bodyModel[58].setRotationPoint(39F, -2F, 15.5F);
		bodyModel[58].rotateAngleX = 0.10471976F;
		...
		turretModel[7].addShapeBox(-13F, 0F, -3F, 0, 1, 6, 0F,2F, 3F, 1F,2F, 4F, 5F,2F, 4F, 5F,2F, 3F, 1F,6F, 0F, 2F,2F, 0F, 10F,2F, 0F, 10F,6F, 0F, 2F); // Box 20
		...
		turretModel[16].addShapeBox(0F, 0F, -5F, 3, 1, 10, 0F,11F, 4F, 3F,8F, 2F, 8F,8F, 2F, 8F,11F, 4F, 3F,11F, 0F, 5F,8F, 0F, 12F,8F, 0F, 12F,11F, 0F, 5F); // Box 218
