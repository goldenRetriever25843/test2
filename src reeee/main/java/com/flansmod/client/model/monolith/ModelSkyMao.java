...
public class ModelSkyMao extends ModelPlane
{
	int textureX = 512;
	int textureY = 512;
	...
	public ModelSkyMao()
	{
		...
		bodyModel[16] = new ModelRendererTurbo(this, 377, 1, textureX, textureY); // HUD Glass
		bodyModel[17] = new ModelRendererTurbo(this, 465, 1, textureX, textureY); // Chair Support
		bodyModel[18] = new ModelRendererTurbo(this, 289, 1, textureX, textureY); // Not Nose Right
		bodyModel[19] = new ModelRendererTurbo(this, 353, 1, textureX, textureY); // Not Nose Left
		bodyModel[20] = new ModelRendererTurbo(this, 385, 1, textureX, textureY); // Upper Cockpt Side Right
		bodyModel[21] = new ModelRendererTurbo(this, 393, 1, textureX, textureY); // Upper Cockpit Side Left
		bodyModel[22] = new ModelRendererTurbo(this, 401, 1, textureX, textureY); // CockPit Transition Right
		bodyModel[23] = new ModelRendererTurbo(this, 441, 1, textureX, textureY); // Cockpit transition Left
		bodyModel[24] = new ModelRendererTurbo(this, 41, 9, textureX, textureY); // Right Spinal Chord
		bodyModel[25] = new ModelRendererTurbo(this, 49, 9, textureX, textureY); // Left Spinal Chord
		bodyModel[26] = new ModelRendererTurbo(this, 105, 9, textureX, textureY); // Intake Ball Left
		bodyModel[27] = new ModelRendererTurbo(this, 113, 9, textureX, textureY); // Intake Ball Right
		...
		bodyModel[16].addBox(0F, 0F, 0F, 1, 3, 4, 0F); // HUD Glass
		bodyModel[16].setRotationPoint(-165.5F, -62F, -2F);

		bodyModel[17].addBox(0F, 0F, 0F, 6, 25, 12, 0F); // Chair Support
		bodyModel[17].setRotationPoint(-138F, -67F, -6F);
		bodyModel[17].rotateAngleZ = -0.17453293F;

		bodyModel[18].addShapeBox(0F, 0F, 0F, 1, 1, 1, 0F, 17F, 15F, 0F, 0F, 18F, 0F, 0F, 4F, 18F, 17F, 4F, 18F, 17F, 15F, 0F, 0F, 15F, 0F, 0F, 11F, 4F, 17F, 11F, 4F); // Not Nose Right
		bodyModel[18].setRotationPoint(-179F, -40F, 0F);

		bodyModel[19].addShapeBox(0F, 0F, 0F, 1, 1, 1, 0F, 17F, 4F, 18F, 0F, 4F, 18F, 0F, 18F, 0F, 17F, 15F, 0F, 17F, 11F, 4F, 0F, 11F, 4F, 0F, 15F, 0F, 17F, 15F, 0F); // Not Nose Left
		bodyModel[19].setRotationPoint(-179F, -40F, -1F);

		bodyModel[20].addShapeBox(0F, 0F, 0F, 1, 1, 1, 0F, 45.5F, 11F, -10F, 0F, 18F, -12F, 0F, 8.4F, 22.3F, 45F, 4F, 18F, 17F, 6F, -10F, 0F, 6F, -10F, 0F, 4F, 12F, 17F, 4F, 10F); // Upper Cockpt Side Right
		bodyModel[20].setRotationPoint(-133F, -40F, 0F);

		bodyModel[21].addShapeBox(0F, 0F, 0F, 1, 1, 1, 0F, 45F, 4F, 18F, 0F, 8.4F, 22.3F, 0F, 18F, -12F, 45.5F, 11F, -10F, 17F, 4F, 10F, 0F, 4F, 12F, 0F, 6F, -10F, 17F, 6F, -10F); // Upper Cockpit Side Left
		bodyModel[21].setRotationPoint(-133F, -40F, -1F);

		bodyModel[22].addShapeBox(0F, 0F, 0F, 1, 1, 1, 0F, 45.5F, 28F, 0F, 0F, 22F, 0F, 0F, 12F, 22.3F, 45F, 8.4F, 22.3F, 50F, 0F, 0F, 0F, 0F, 0F, 0F, 4F, 12F, 45F, 4F, 10F); // CockPit Transition Right
		bodyModel[22].setRotationPoint(-87F, -40F, 0F);

		bodyModel[23].addShapeBox(0F, 0F, 0F, 1, 1, 1, 0F, 45F, 8.4F, 22.3F, 0F, 12F, 22.3F, 0F, 22F, 0F, 45.5F, 28F, 0F, 45F, 4F, 10F, 0F, 4F, 12F, 0F, 0F, 0F, 50F, 0F, 0F); // Cockpit transition Left
		bodyModel[23].setRotationPoint(-87F, -40F, -1F);

		bodyModel[24].addShapeBox(0F, 0F, 0F, 1, 1, 1, 0F, 205F, 22F, 0F, 0F, 18F, 0F, 0F, 10F, 30F, 205F, 12F, 22.3F, 17F, 0F, 0F, 0F, 0F, 0F, 0F, 4F, 12F, 17F, 4F, 10F); // Right Spinal Chord
		bodyModel[24].setRotationPoint(119F, -40F, 0F);

		bodyModel[25].addShapeBox(0F, 0F, 0F, 1, 1, 1, 0F, 205F, 12F, 22.3F, 0F, 10F, 30F, 0F, 18F, 0F, 205F, 22F, 0F, 17F, 4F, 10F, 0F, 4F, 12F, 0F, 0F, 0F, 17F, 0F, 0F); // Left Spinal Chord
		bodyModel[25].setRotationPoint(119F, -40F, -1F);

		bodyModel[26].addShapeBox(0F, 0F, 0F, 1, 1, 1, 0F, 40F, 4F, 20F, 0F, 4F, 20F, 0F, 8F, 0F, 50F, 8F, -18F, 25F, 4F, 22F, 0F, 6F, 22F, 0F, 18F, 0F, 30F, 18F, 0F); // Intake Ball Left
		bodyModel[26].setRotationPoint(-95F, -41F, -1F);

		bodyModel[27].addShapeBox(0F, 0F, 0F, 1, 1, 1, 0F, 50F, 8F, -18F, 0F, 8F, 0F, 0F, 4F, 20F, 40F, 4F, 20F, 30F, 18F, 0F, 0F, 18F, 0F, 0F, 6F, 22F, 25F, 4F, 22F); // Intake Ball Right
		bodyModel[27].setRotationPoint(-95F, -41F, 0F);
		...
		tailModel[8] = new ModelRendererTurbo(this, 73, 9, textureX, textureY); // Spine Splitters Left
		tailModel[9] = new ModelRendererTurbo(this, 89, 9, textureX, textureY); // Weird Thing Right
		tailModel[10] = new ModelRendererTurbo(this, 97, 9, textureX, textureY); // Weird Thing Left
		tailModel[11] = new ModelRendererTurbo(this, 193, 9, textureX, textureY); // Tail Fin Right Base
		...
		tailModel[7].addShapeBox(0F, 0F, 0F, 5, 1, 1, 0F, 80F, 18F, 0F, 0F, 12F, -12F, 0F, 7F, 40F, 80F, 12F, 22F, 17F, 0F, 0F, 0F, 0F, 30F, 0F, 4F, 12F, 17F, 4F, 10F); // Spine Splitters Right
		tailModel[7].setRotationPoint(200F, -40F, 0F);

		tailModel[8].addShapeBox(0F, 0F, 0F, 5, 1, 1, 0F, 80F, 12F, 22F, 0F, 7F, 40F, 0F, 12F, -12F, 80F, 18F, 0F, 17F, 4F, 10F, 0F, 4F, 12F, 0F, 0F, 30F, 0F, 0F, 30F); // Spine Splitters Left
		tailModel[8].setRotationPoint(200F, -40F, -1F);

		tailModel[9].addShapeBox(0F, 0F, 0F, 1, 1, 1, 0F, 0F, 5F, 15F, 36F, 2F, 0F, 36F, 1F, 12F, 12F, 2.5F, 10F, 0F, 4F, 5F, 36F, 0F, 0F, 36F, 0F, 0F, 0F, 2F, 1F); // Weird Thing Right
		tailModel[9].setRotationPoint(205F, -44F, 43F);

		tailModel[10].addShapeBox(0F, 0F, 0F, 1, 1, 1, 0F, 12F, 2.5F, 10F, 36F, 1F, 12F, 36F, 2F, 0F, 0F, 5F, 15F, 0F, 2F, 1F, 36F, 0F, 0F, 36F, 0F, 0F, 0F, 4F, 5F); // Weird Thing Left
		tailModel[10].setRotationPoint(205F, -44F, -44F);

		tailModel[11].addShapeBox(20F, 0F, 0F, 1, 1, 1, 0F, 55F, 0F, 1F, 0F, 1F, 0F, 4F, 1F, 10F, 46F, 0.3F, 10F, 55F, 0F, 1F, 0F, 1F, 0F, 4F, 1F, 10F, 46F, 0F, 10F); // Tail Fin Right Base
		tailModel[11].setRotationPoint(200F, -48F, 48F);
		tailModel[11].rotateAngleX = 1.08210414F;
		...
		leftWingModel[2].setRotationPoint(158F, -45.5F, -121F);
		...
		yawFlapModel[4].setRotationPoint(200F, -48F, -50.3F);
		yawFlapModel[4].rotateAngleX = -1.09083078F;
		yawFlapModel[4].rotateAngleY = -0.03490659F;

		yawFlapModel[5].addBox(0F, 1F, 14F, 23, 1, 28, 0F); // Yaw Sticker Right
		yawFlapModel[5].setRotationPoint(200F, -48F, 48.5F);
		...
		bodyWheelModel[9].setRotationPoint(-105F, -19F, 1F);

		bodyWheelModel[10].addBox(0F, 0F, 0F, 10, 10, 3, 0F); // Center Wheel
		bodyWheelModel[10].setRotationPoint(-108.5F, 6F, -2F);
		...
		bodyDoorOpenModel[22].setRotationPoint(-46F, -32F, -39.4F);
