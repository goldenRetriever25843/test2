...
public class ModelLemuria extends ModelCustomArmour //Same as Filename
{
	int textureX = 512;
	int textureY = 512;

	public ModelLemuria() //Same as Filename
	{
	...
	private void initheadModel_1()
	{
		...
		headModel[14] = new ModelRendererTurbo(this, 373, 66, textureX, textureY); // Box 118
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[1] = new ModelRendererTurbo(this, 133, 46, textureX, textureY); // Box 62
		bodyModel[2] = new ModelRendererTurbo(this, 166, 58, textureX, textureY); // Box 64
		bodyModel[3] = new ModelRendererTurbo(this, 172, 50, textureX, textureY); // Box 0
		bodyModel[4] = new ModelRendererTurbo(this, 149, 51, textureX, textureY); // Box 1
		bodyModel[5] = new ModelRendererTurbo(this, 414, 51, textureX, textureY); // Box 12
		bodyModel[6] = new ModelRendererTurbo(this, 413, 61, textureX, textureY); // Box 13
		bodyModel[7] = new ModelRendererTurbo(this, 429, 68, textureX, textureY); // Box 15
		bodyModel[8] = new ModelRendererTurbo(this, 169, 1, textureX, textureY); // Box 16
		bodyModel[9] = new ModelRendererTurbo(this, 277, 64, textureX, textureY); // Box 17
		bodyModel[10] = new ModelRendererTurbo(this, 78, 48, textureX, textureY); // Box 0
		bodyModel[11] = new ModelRendererTurbo(this, 87, 53, textureX, textureY); // Box 7
		bodyModel[12] = new ModelRendererTurbo(this, 99, 59, textureX, textureY); // Box 8
		bodyModel[13] = new ModelRendererTurbo(this, 110, 51, textureX, textureY); // Box 9
		bodyModel[14] = new ModelRendererTurbo(this, 85, 61, textureX, textureY); // Box 10
		bodyModel[15] = new ModelRendererTurbo(this, 73, 58, textureX, textureY); // Box 12
		bodyModel[16] = new ModelRendererTurbo(this, 385, 62, textureX, textureY); // Box 14
		bodyModel[17] = new ModelRendererTurbo(this, 280, 60, textureX, textureY); // Box 18
		bodyModel[18] = new ModelRendererTurbo(this, 409, 1, textureX, textureY); // Box 19
		bodyModel[19] = new ModelRendererTurbo(this, 399, 67, textureX, textureY); // Box 20
		bodyModel[20] = new ModelRendererTurbo(this, 431, 47, textureX, textureY); // Box 21
		bodyModel[21] = new ModelRendererTurbo(this, 416, 59, textureX, textureY); // Box 22
		bodyModel[22] = new ModelRendererTurbo(this, 418, 55, textureX, textureY); // Box 23
		bodyModel[23] = new ModelRendererTurbo(this, 274, 62, textureX, textureY); // Box 1
		bodyModel[24] = new ModelRendererTurbo(this, 278, 54, textureX, textureY); // Box 2
		bodyModel[25] = new ModelRendererTurbo(this, 284, 56, textureX, textureY); // Box 3
		bodyModel[26] = new ModelRendererTurbo(this, 345, 9, textureX, textureY); // Box 4
		bodyModel[27] = new ModelRendererTurbo(this, 129, 51, textureX, textureY); // Box 5
		bodyModel[28] = new ModelRendererTurbo(this, 193, 23, textureX, textureY); // Box 7
		...
		bodyModel[32] = new ModelRendererTurbo(this, 412, 59, textureX, textureY); // Box 12
		bodyModel[33] = new ModelRendererTurbo(this, 428, 55, textureX, textureY); // Box 13
		bodyModel[34] = new ModelRendererTurbo(this, 233, 17, textureX, textureY); // Box 2
		bodyModel[35] = new ModelRendererTurbo(this, 485, 19, textureX, textureY); // Box 10
		...
		bodyModel[45] = new ModelRendererTurbo(this, 374, 65, textureX, textureY); // Box 41
		bodyModel[46] = new ModelRendererTurbo(this, 425, 64, textureX, textureY); // Box 42
		bodyModel[47] = new ModelRendererTurbo(this, 374, 56, textureX, textureY); // Box 43
		bodyModel[48] = new ModelRendererTurbo(this, 372, 49, textureX, textureY); // Box 44
		bodyModel[49] = new ModelRendererTurbo(this, 435, 54, textureX, textureY); // Box 45
		bodyModel[50] = new ModelRendererTurbo(this, 403, 51, textureX, textureY); // Box 46
		bodyModel[51] = new ModelRendererTurbo(this, 441, 61, textureX, textureY); // Box 47
		bodyModel[52] = new ModelRendererTurbo(this, 76, 68, textureX, textureY); // Box 11
		...
		bodyModel[56] = new ModelRendererTurbo(this, 110, 15, textureX, textureY); // Box 97
		bodyModel[57] = new ModelRendererTurbo(this, 66, 15, textureX, textureY); // Box 98
		bodyModel[58] = new ModelRendererTurbo(this, 159, 21, textureX, textureY); // Box 99
		bodyModel[59] = new ModelRendererTurbo(this, 148, 15, textureX, textureY); // Box 100
		bodyModel[60] = new ModelRendererTurbo(this, 345, 17, textureX, textureY); // Box 101
		bodyModel[61] = new ModelRendererTurbo(this, 372, 55, textureX, textureY); // Box 102
		bodyModel[62] = new ModelRendererTurbo(this, 404, 54, textureX, textureY); // Box 103

		bodyModel[0].addShapeBox(-4.1F, 0F, -2.1F, 16, 24, 8, 0F,0F, 0.1F, 0.05F, -7.8F, 0.1F, 0.05F, -7.8F, 0.1F, -3.75F, 0F, 0.1F, -3.75F, 0F, -12F, 0.05F, -7.8F, -12F, 0.05F, -7.8F, -12F, -3.75F, 0F, -12F, -3.75F); // Box 1
		bodyModel[0].setRotationPoint(0F, 0F, 0F);

		bodyModel[1].addShapeBox(-4F, 7F, -2F, 8, 4, 4, 0F,0.35F, 0.2F, 0.3F, 0.35F, 0.2F, 0.3F, 0.35F, 0.2F, 0.3F, 0.35F, 0.2F, 0.3F, 0.35F, 0.05F, 0.3F, 0.35F, 0.05F, 0.3F, 0.35F, 0.05F, 0.3F, 0.35F, 0.05F, 0.3F); // Box 62
		...
		bodyModel[53].addShapeBox(1.6F, 3F, -3.3F, 2, 3, 1, 0F,-0.2F, 0F, 0F, -0.2F, 0F, 0F, -0.2F, 0F, 0F, -0.2F, 0F, 0F, -0.2F, -0.5F, 0F, -0.2F, -0.5F, 0F, -0.2F, -0.5F, 0F, -0.2F, -0.5F, 0F); // Box 4
		bodyModel[53].setRotationPoint(0F, 0F, 0F);

		bodyModel[54].addShapeBox(2.6F, 0.4F, -3.5F, 1, 2, 1, 0F,-0.45F, 0F, -0.45F, -0.45F, 0F, -0.45F, -0.45F, 0F, -0.45F, -0.45F, 0F, -0.45F, -0.45F, 0F, -0.45F, -0.45F, 0F, -0.45F, -0.45F, 0F, -0.45F, -0.45F, 0F, -0.45F); // Box 5
		bodyModel[54].setRotationPoint(0F, 0F, 0F);

		bodyModel[55].addShapeBox(2.6F, 2.4F, -3.5F, 1, 1, 1, 0F,-0.4F, 0F, -0.4F, -0.4F, 0F, -0.4F, -0.4F, 0F, -0.4F, -0.4F, 0F, -0.4F, -0.3F, 0F, -0.3F, -0.3F, 0F, -0.3F, -0.3F, 0F, -0.3F, -0.3F, 0F, -0.3F); // Box 6
		bodyModel[55].setRotationPoint(0F, 0F, 0F);

		bodyModel[56].addShapeBox(-5F, 9F, -1.5F, 1, 3, 3, 0F,0F, 0F, -0.15F, 0F, 0F, -0.15F, 0F, 0F, -0.25F, 0F, 0F, -0.25F, 0F, -0.1F, -0.15F, 0F, -0.1F, -0.15F, 0F, -0.1F, -0.25F, 0F, -0.1F, -0.25F); // Box 97
		...
		bodyModel[59].addShapeBox(4F, 9F, -1.5F, 1, 3, 3, 0F,0F, 0F, -0.15F, 0F, 0F, -0.15F, 0F, 0F, -0.25F, 0F, 0F, -0.25F, 0F, -0.1F, -0.15F, 0F, -0.1F, -0.15F, 0F, -0.1F, -0.25F, 0F, -0.1F, -0.25F); // Box 100
		...
		bodyModel[61].addShapeBox(-2F, 5.25F, 3.96F, 4, 1, 1, 0F,0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -0.2F, 0F, 0F, -0.2F, 0F, 0F, -0.2F, 0F, 0F, -0.2F, 0F); // Box 102
	...
	{
		leftArmModel[0] = new ModelRendererTurbo(this, 57, 1, textureX, textureY); // Box 4
	...
	private void initleftLegModel_1()
	{
		...
		leftLegModel[6] = new ModelRendererTurbo(this, 272, 52, textureX, textureY); // Box 107
		leftLegModel[7] = new ModelRendererTurbo(this, 267, 50, textureX, textureY); // Box 108
		leftLegModel[8] = new ModelRendererTurbo(this, 269, 56, textureX, textureY); // Box 109
	...
	private void initrightLegModel_1()
	{
		...
		rightLegModel[2] = new ModelRendererTurbo(this, 387, 69, textureX, textureY); // Box 117
		rightLegModel[3] = new ModelRendererTurbo(this, 393, 69, textureX, textureY); // Box 116
		...
		rightLegModel[6] = new ModelRendererTurbo(this, 268, 63, textureX, textureY); // Box 67
		...
		rightLegModel[11] = new ModelRendererTurbo(this, 289, 69, textureX, textureY); // Box 99
		rightLegModel[12] = new ModelRendererTurbo(this, 274, 55, textureX, textureY); // Box 100
