...
public class ModelFalken extends ModelPlane
{
    ...
    public ModelFalken()
    {
        ...
        propellerModels[0][0].addBox(-0F, -12F, -1F, 1, 1, 1, 0.0F);		//Propeller Blades
        propellerModels[0][1].addBox(-0F, -12F, -1F, 1, 1, 1, 0.0F);		//They will all be the same
        propellerModels[0][2].addBox(-0F, -12F, -1F, 1, 1, 1, 0.0F);		
        propellerModels[0][0].setRotationPoint(-52, -30, 0);	//Set the position of the propeller
        propellerModels[0][1].setRotationPoint(-52, -30, 0);	
        propellerModels[0][2].setRotationPoint(-52, -30, 0);	
