...
public class ModelG36Clabjac extends ModelGun
{
	int textureX = 512;
	int textureY = 512;

	public ModelG36Clabjac()
	{
		...
		gunModel[13] = new ModelRendererTurbo(this, 281, 1, textureX, textureY); // Box 15
		gunModel[14] = new ModelRendererTurbo(this, 313, 1, textureX, textureY); // Box 17
		gunModel[15] = new ModelRendererTurbo(this, 329, 1, textureX, textureY); // Box 18
		gunModel[16] = new ModelRendererTurbo(this, 353, 1, textureX, textureY); // Box 19
		gunModel[17] = new ModelRendererTurbo(this, 425, 1, textureX, textureY); // Box 24
		gunModel[18] = new ModelRendererTurbo(this, 433, 1, textureX, textureY); // Box 25
		gunModel[19] = new ModelRendererTurbo(this, 441, 1, textureX, textureY); // Box 26
		...
		gunModel[7].addShapeBox(0F, 0F, 0F, 5, 2, 2, 0F,0F, 0F, -0.1F, -1.2F, 0F, -0.1F, -1.2F, 0F, -0.1F, 0F, 0F, -0.1F, 0F, 0F, 0.2F, -0.3F, 0F, 0.2F, -0.3F, 0F, 0.2F, 0F, 0F, 0.2F); // Box 7
		...
		gunModel[9].addShapeBox(0F, 0F, 0F, 11, 1, 2, 0F,0F, 0F, 0.2F, -0.3F, 0F, 0.2F, -0.3F, 0F, 0.2F, 0F, 0F, 0.2F, 0F, 0F, -0.1F, -0.5F, 0F, -0.1F, -0.5F, 0F, -0.1F, 0F, 0F, -0.1F); // Box 9
		...
		gunModel[12].setRotationPoint(13F, -4.6F, -0.5F);

		gunModel[13].addShapeBox(0F, 0F, 0F, 3, 1, 1, 0F,-0.3F, 0F, 0F, -0.3F, 0F, 0F, -0.3F, 0F, 0F, -0.3F, 0F, 0F, -0.3F, 0F, 0F, -0.3F, 0F, 0F, -0.3F, 0F, 0F, -0.3F, 0F, 0F); // Box 15
		gunModel[13].setRotationPoint(18.4F, -4.6F, -0.5F);

		gunModel[14].addShapeBox(0F, 0F, 0F, 4, 2, 1, 0F,0.3F, 0F, 0.1F, 0.3F, 0F, 0.1F, 0.3F, 0F, 0.1F, 0.3F, 0F, 0.1F, 0.3F, -0.4F, 0.1F, 0.3F, -0.4F, 0.1F, 0.3F, -0.4F, 0.1F, 0.3F, -0.4F, 0.1F); // Box 17
		gunModel[14].setRotationPoint(-0.8F, -7.2F, -0.5F);

		gunModel[15].addShapeBox(0F, 0F, 0F, 8, 2, 1, 0F,0.3F, 0F, 0.1F, 0.3F, 0F, 0.1F, 0.3F, 0F, 0.1F, 0.3F, 0F, 0.1F, 0.3F, -1.8F, 0.1F, 0.3F, -1.8F, 0.1F, 0.3F, -1.8F, 0.1F, 0.3F, -1.8F, 0.1F); // Box 18
		gunModel[15].setRotationPoint(3.3F, -7.2F, -0.5F);

		gunModel[16].addShapeBox(0F, 0F, 0F, 1, 3, 1, 0F,0F, 0F, 0.1F, 0.3F, 0F, 0.1F, 0.3F, 0F, 0.1F, 0F, 0F, 0.1F, -2.2F, -1.8F, 0.1F, 2.5F, -1.8F, 0.1F, 2.5F, -1.8F, 0.1F, -2.2F, -1.8F, 0.1F); // Box 19
		gunModel[16].setRotationPoint(10.3F, -7.2F, -0.5F);

		gunModel[17].addShapeBox(0F, 0F, 0F, 2, 1, 1, 0F,0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -0.9F, 0F, 0F, -0.9F, 0F, 0F, -0.9F, 0F, 0F, -0.9F, 0F); // Box 24
		gunModel[17].setRotationPoint(1.6F, -0.3F, -0.5F);
		gunModel[17].rotateAngleZ = 0.08726646F;

		gunModel[18].addShapeBox(0F, 0F, 0F, 1, 1, 1, 0F,0.2F, 0F, 0F, 0.2F, 0F, 0F, 0.2F, 0F, 0F, 0.2F, 0F, 0F, 0.2F, -0.9F, 0F, 0.2F, -0.9F, 0F, 0.2F, -0.9F, 0F, 0.2F, -0.9F, 0F); // Box 25
		gunModel[18].setRotationPoint(0.6F, -0.7F, -0.5F);
		gunModel[18].rotateAngleZ = -0.36651914F;

		gunModel[19].addShapeBox(0F, 0F, 0F, 1, 1, 1, 0F,0.2F, 0F, -0.3F, 0.2F, 0F, -0.3F, 0.2F, 0F, -0.3F, 0.2F, 0F, -0.3F, 0.2F, -0.9F, -0.3F, 0.2F, -0.9F, -0.3F, 0.2F, -0.9F, -0.3F, 0.2F, -0.9F, -0.3F); // Box 26
		gunModel[19].setRotationPoint(1.8F, -1.9F, -0.5F);
		gunModel[19].rotateAngleZ = -1.65806279F;
