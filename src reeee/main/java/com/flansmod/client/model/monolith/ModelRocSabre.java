...
public class ModelRocSabre extends ModelPlane //Same as Filename
{
	int textureX = 512;
	int textureY = 512;

	public ModelRocSabre() //Same as Filename
	{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[16] = new ModelRendererTurbo(this, 282, 49, textureX, textureY); // Box 20
	...
	private void inittailModel_1()
	{
		...
		tailModel[6] = new ModelRendererTurbo(this, 324, 424, textureX, textureY); // Box 101
		tailModel[7] = new ModelRendererTurbo(this, 348, 459, textureX, textureY); // Box 102
		...
		tailModel[7].addBox(4F, 0F, 0F, 17, 15, 1, 0F); // Box 102
	...
	private void initleftWingModel_1()
	{
		...
		leftWingModel[1] = new ModelRendererTurbo(this, 334, 424, textureX, textureY); // Box 97
	...
	private void initrightWingModel_1()
	{
		...
		rightWingModel[1] = new ModelRendererTurbo(this, 334, 425, textureX, textureY); // Box 96
