...
public class ModelVickers extends ModelVehicle //Same as Filename
{
	int textureX = 512;
	int textureY = 512;

	public ModelVickers() //Same as Filename
	{
		bodyModel = new ModelRendererTurbo[21];
		bodyDoorOpenModel = new ModelRendererTurbo[161];
	...
	private void initbodyDoorOpenModel_1()
	{
		...
		bodyDoorOpenModel[154] = new ModelRendererTurbo(this, 425, 38, textureX, textureY); // Box 245
		bodyDoorOpenModel[155] = new ModelRendererTurbo(this, 505, 38, textureX, textureY); // Box 246
		bodyDoorOpenModel[156] = new ModelRendererTurbo(this, 497, 38, textureX, textureY); // Box 247
		bodyDoorOpenModel[157] = new ModelRendererTurbo(this, 1, 38, textureX, textureY); // Box 248
		bodyDoorOpenModel[158] = new ModelRendererTurbo(this, 1, 38, textureX, textureY); // Box 249
		bodyDoorOpenModel[159] = new ModelRendererTurbo(this, 1, 38, textureX, textureY); // Box 250
		bodyDoorOpenModel[160] = new ModelRendererTurbo(this, 1, 38, textureX, textureY); // Box 251
		...
		bodyDoorOpenModel[9].addShapeBox(0F, -3F, -8F, 1, 4, 8, 0F,0F, 0F, -0.5F, -0.5F, 0F, 0F, -0.5F, 0F, 0F, 0F, 0F, -0.5F, 0F, 0F, -0.5F, -0.5F, 0F, 0F, -0.5F, 0F, 0F, 0F, 0F, -0.5F); // Box 54
		bodyDoorOpenModel[9].setRotationPoint(-4.25F, 9F, -6F);

		bodyDoorOpenModel[10].addShapeBox(2F, -3F, -8F, 1, 4, 8, 0F,-0.5F, 0F, 0F, 0F, 0F, -0.5F, 0F, 0F, -0.5F, -0.5F, 0F, 0F, -0.5F, 0F, 0F, 0F, 0F, -0.5F, 0F, 0F, -0.5F, -0.5F, 0F, 0F); // Box 55
		...
		bodyDoorOpenModel[14].addShapeBox(0F, -4F, -9.5F, 1, 1, 8, 0F,0F, 0F, -0.5F, -0.5F, 0F, 0F, -0.5F, 0F, 0F, 0F, 0F, -0.5F, 0F, 0F, -0.5F, -0.5F, 0F, 0F, -0.5F, 0F, 0F, 0F, 0F, -0.5F); // Box 62
		bodyDoorOpenModel[14].setRotationPoint(-4.25F, 9F, -6F);

		bodyDoorOpenModel[15].addShapeBox(2F, -4F, -9.5F, 1, 1, 8, 0F,-0.5F, 0F, 0F, 0F, 0F, -0.5F, 0F, 0F, -0.5F, -0.5F, 0F, 0F, -0.5F, 0F, 0F, 0F, 0F, -0.5F, 0F, 0F, -0.5F, -0.5F, 0F, 0F); // Box 62
		...
		bodyDoorOpenModel[154].addShapeBox(-3.2F, 4.5F, -14.5F, 1, 1, 1, 0F,-0.1F, -1.6F, 0F, -0.1F, -1.6F, 0F, -0.1F, -0.8F, 0F, -0.1F, -0.8F, 0F, -0.1F, 0.6F, -0.2F, -0.1F, 0.6F, -0.2F, -0.1F, 0F, 0F, -0.1F, 0F, 0F); // Box 245
		bodyDoorOpenModel[154].setRotationPoint(0F, -1F, 0F);

		bodyDoorOpenModel[155].addShapeBox(-3.2F, 4.5F, -9.5F, 1, 1, 1, 0F,-0.1F, -0.8F, 0F, -0.1F, -0.8F, 0F, -0.1F, -1.6F, 0F, -0.1F, -1.6F, 0F, -0.1F, 0F, 0F, -0.1F, 0F, 0F, -0.1F, 0.6F, -0.2F, -0.1F, 0.6F, -0.2F); // Box 246
		bodyDoorOpenModel[155].setRotationPoint(0F, -1F, 0F);

		bodyDoorOpenModel[156].addShapeBox(-3.2F, 4.5F, -13.5F, 1, 1, 4, 0F,0F, -0.75F, 0F, 0F, -0.75F, 0F, 0F, -0.75F, 0F, 0F, -0.75F, 0F, 0F, 0.05F, 0F, 0F, 0.05F, 0F, 0F, 0.05F, 0F, 0F, 0.05F, 0F); // Box 247
		bodyDoorOpenModel[156].setRotationPoint(0F, -1F, 0F);

		bodyDoorOpenModel[157].addShapeBox(-3F, 6.2F, -7.5F, 1, 1, 1, 0F,0.5F, -0.2F, 0F, 0F, -0.2F, 0F, 0F, -0.2F, -0.8F, 0.5F, -0.2F, -0.8F, 0.5F, -0.2F, 0F, 0F, -0.2F, 0F, 0F, -0.2F, -0.8F, 0.5F, -0.2F, -0.8F); // Box 248
		bodyDoorOpenModel[157].setRotationPoint(0F, -1F, 0F);

		bodyDoorOpenModel[158].addShapeBox(-3F, 6.2F, -16.5F, 1, 1, 1, 0F,0.5F, -0.2F, -0.8F, 0F, -0.2F, -0.8F, 0F, -0.2F, 0F, 0.5F, -0.2F, 0F, 0.5F, -0.2F, -0.8F, 0F, -0.2F, -0.8F, 0F, -0.2F, 0F, 0.5F, -0.2F, 0F); // Box 249
		bodyDoorOpenModel[158].setRotationPoint(0F, -1F, 0F);

		bodyDoorOpenModel[159].addShapeBox(-3F, 6.8F, -15F, 1, 1, 1, 0F,0.5F, -0.2F, -0.8F, 0F, -0.2F, -0.8F, 0F, -0.2F, 0F, 0.5F, -0.2F, 0F, 0.5F, -0.2F, -0.8F, 0F, -0.2F, -0.8F, 0F, -0.2F, 0F, 0.5F, -0.2F, 0F); // Box 250
		bodyDoorOpenModel[159].setRotationPoint(0F, -1F, 0F);

		bodyDoorOpenModel[160].addShapeBox(-3F, 6.8F, -6F, 1, 1, 1, 0F,0.5F, -0.2F, 0F, 0F, -0.2F, 0F, 0F, -0.2F, -0.8F, 0.5F, -0.2F, -0.8F, 0.5F, -0.2F, 0F, 0F, -0.2F, 0F, 0F, -0.2F, -0.8F, 0.5F, -0.2F, -0.8F); // Box 251
		bodyDoorOpenModel[160].setRotationPoint(0F, -1F, 0F);
	}
	...
	{
		barrelModel[0] = new ModelRendererTurbo(this, 33, 1, textureX, textureY); // Box 0
		barrelModel[1] = new ModelRendererTurbo(this, 49, 1, textureX, textureY); // Box 0
		barrelModel[2] = new ModelRendererTurbo(this, 97, 1, textureX, textureY); // Box 0
		barrelModel[3] = new ModelRendererTurbo(this, 105, 1, textureX, textureY); // Box 0
		barrelModel[4] = new ModelRendererTurbo(this, 113, 1, textureX, textureY); // Box 0
		barrelModel[5] = new ModelRendererTurbo(this, 121, 1, textureX, textureY); // Box 0
		barrelModel[6] = new ModelRendererTurbo(this, 129, 1, textureX, textureY); // Box 0
		barrelModel[7] = new ModelRendererTurbo(this, 137, 1, textureX, textureY); // Box 0
		barrelModel[8] = new ModelRendererTurbo(this, 145, 1, textureX, textureY); // Box 0
		barrelModel[9] = new ModelRendererTurbo(this, 249, 1, textureX, textureY); // Box 0
		barrelModel[10] = new ModelRendererTurbo(this, 257, 1, textureX, textureY); // Box 0
		barrelModel[11] = new ModelRendererTurbo(this, 281, 1, textureX, textureY); // Box 0
		barrelModel[12] = new ModelRendererTurbo(this, 289, 1, textureX, textureY); // Box 0
		barrelModel[13] = new ModelRendererTurbo(this, 377, 1, textureX, textureY); // Box 0
		barrelModel[14] = new ModelRendererTurbo(this, 385, 1, textureX, textureY); // Box 0
		barrelModel[15] = new ModelRendererTurbo(this, 393, 1, textureX, textureY); // Box 0
		barrelModel[16] = new ModelRendererTurbo(this, 457, 1, textureX, textureY); // Box 0
		barrelModel[17] = new ModelRendererTurbo(this, 465, 1, textureX, textureY); // Box 0
		barrelModel[18] = new ModelRendererTurbo(this, 481, 1, textureX, textureY); // Box 0
		barrelModel[19] = new ModelRendererTurbo(this, 489, 1, textureX, textureY); // Box 0
		barrelModel[20] = new ModelRendererTurbo(this, 401, 38, textureX, textureY); // Box 0
		barrelModel[21] = new ModelRendererTurbo(this, 409, 38, textureX, textureY); // Box 0
		barrelModel[22] = new ModelRendererTurbo(this, 417, 38, textureX, textureY); // Box 0
		barrelModel[23] = new ModelRendererTurbo(this, 425, 38, textureX, textureY); // Box 0
		barrelModel[24] = new ModelRendererTurbo(this, 433, 38, textureX, textureY); // Box 0
		barrelModel[25] = new ModelRendererTurbo(this, 441, 38, textureX, textureY); // Box 0
		barrelModel[26] = new ModelRendererTurbo(this, 241, 38, textureX, textureY); // Box 0
		barrelModel[27] = new ModelRendererTurbo(this, 249, 38, textureX, textureY); // Box 1
		barrelModel[28] = new ModelRendererTurbo(this, 65, 38, textureX, textureY); // Box 2
		barrelModel[29] = new ModelRendererTurbo(this, 89, 38, textureX, textureY); // Box 3
		barrelModel[30] = new ModelRendererTurbo(this, 137, 38, textureX, textureY); // Box 4
		barrelModel[31] = new ModelRendererTurbo(this, 185, 38, textureX, textureY); // Box 5
		barrelModel[32] = new ModelRendererTurbo(this, 233, 38, textureX, textureY); // Box 6
		barrelModel[33] = new ModelRendererTurbo(this, 257, 38, textureX, textureY); // Box 7
		barrelModel[34] = new ModelRendererTurbo(this, 265, 38, textureX, textureY); // Box 8
		barrelModel[35] = new ModelRendererTurbo(this, 273, 38, textureX, textureY); // Box 9
		barrelModel[36] = new ModelRendererTurbo(this, 281, 38, textureX, textureY); // Box 10
		barrelModel[37] = new ModelRendererTurbo(this, 289, 38, textureX, textureY); // Box 11
		barrelModel[38] = new ModelRendererTurbo(this, 297, 38, textureX, textureY); // Box 12
		barrelModel[39] = new ModelRendererTurbo(this, 305, 38, textureX, textureY); // Box 13
		barrelModel[40] = new ModelRendererTurbo(this, 313, 38, textureX, textureY); // Box 14
		barrelModel[41] = new ModelRendererTurbo(this, 329, 38, textureX, textureY); // Box 15
		barrelModel[42] = new ModelRendererTurbo(this, 345, 38, textureX, textureY); // Box 16
		barrelModel[43] = new ModelRendererTurbo(this, 321, 38, textureX, textureY); // Box 17
		barrelModel[44] = new ModelRendererTurbo(this, 337, 38, textureX, textureY); // Box 18
		barrelModel[45] = new ModelRendererTurbo(this, 353, 38, textureX, textureY); // Box 19
		barrelModel[46] = new ModelRendererTurbo(this, 65, 1, textureX, textureY); // Box 0
		barrelModel[47] = new ModelRendererTurbo(this, 81, 1, textureX, textureY); // Box 1
		barrelModel[48] = new ModelRendererTurbo(this, 153, 1, textureX, textureY); // Box 2
		barrelModel[49] = new ModelRendererTurbo(this, 169, 1, textureX, textureY); // Box 3
		barrelModel[50] = new ModelRendererTurbo(this, 185, 1, textureX, textureY); // Box 4
		barrelModel[51] = new ModelRendererTurbo(this, 217, 1, textureX, textureY); // Box 5
		barrelModel[52] = new ModelRendererTurbo(this, 19, 57, textureX, textureY); // Box 6
		barrelModel[53] = new ModelRendererTurbo(this, 297, 1, textureX, textureY); // Box 7
		barrelModel[54] = new ModelRendererTurbo(this, 321, 1, textureX, textureY); // Box 9
		barrelModel[55] = new ModelRendererTurbo(this, 345, 1, textureX, textureY); // Box 13
		barrelModel[56] = new ModelRendererTurbo(this, 401, 1, textureX, textureY); // Box 14
		barrelModel[57] = new ModelRendererTurbo(this, 433, 1, textureX, textureY); // Box 16
		barrelModel[58] = new ModelRendererTurbo(this, 1, 9, textureX, textureY); // Box 17
		barrelModel[59] = new ModelRendererTurbo(this, 25, 9, textureX, textureY); // Box 18
		barrelModel[60] = new ModelRendererTurbo(this, 25, 1, textureX, textureY); // Box 19
		barrelModel[61] = new ModelRendererTurbo(this, 41, 1, textureX, textureY); // Box 20
		barrelModel[62] = new ModelRendererTurbo(this, 497, 1, textureX, textureY); // Box 21
		...
		barrelModel[2].addShapeBox(11.5F, -0.2F, -0.5F, 1, 1, 1, 0F,0F, -0.2F, -0.4F, 0.5F, -0.2F, -0.4F, 0.5F, -0.2F, -0.4F, 0F, -0.2F, -0.4F, 0F, -0.6F, -0.2F, 0.5F, -0.6F, -0.2F, 0.5F, -0.6F, -0.2F, 0F, -0.6F, -0.2F); // Box 0
		barrelModel[2].setRotationPoint(0F, -0.5F, 0F);

		barrelModel[3].addShapeBox(11.5F, -0.2F, -0.5F, 1, 1, 1, 0F,0F, -0.6F, -0.2F, 0.5F, -0.6F, -0.2F, 0.5F, -0.6F, -0.2F, 0F, -0.6F, -0.2F, 0F, -0.2F, -0.4F, 0.5F, -0.2F, -0.4F, 0.5F, -0.2F, -0.4F, 0F, -0.2F, -0.4F); // Box 0
		barrelModel[3].setRotationPoint(0F, -0.5F, 0F);

		barrelModel[4].addShapeBox(11.5F, -0.2F, -0.5F, 1, 1, 1, 0F,0F, -0.4F, -0.2F, 0.5F, -0.4F, -0.2F, 0.5F, -0.4F, -0.2F, 0F, -0.4F, -0.2F, 0F, -0.4F, -0.2F, 0.5F, -0.4F, -0.2F, 0.5F, -0.4F, -0.2F, 0F, -0.4F, -0.2F); // Box 0
		barrelModel[4].setRotationPoint(0F, -0.5F, 0F);

		barrelModel[5].addShapeBox(10.5F, -0.2F, -0.5F, 2, 1, 1, 0F,0F, -0.4F, -0.2F, 0F, -0.3F, 0F, 0F, -0.3F, 0F, 0F, -0.4F, -0.2F, 0F, -0.4F, -0.2F, 0F, -0.3F, 0F, 0F, -0.3F, 0F, 0F, -0.4F, -0.2F); // Box 0
		barrelModel[5].setRotationPoint(0F, -0.5F, 0F);

		barrelModel[6].addShapeBox(10.5F, -0.2F, -0.5F, 2, 1, 1, 0F,0F, -0.2F, -0.4F, 0F, 0F, -0.3F, 0F, 0F, -0.3F, 0F, -0.2F, -0.4F, 0F, -0.6F, -0.2F, 0F, -0.7F, 0F, 0F, -0.7F, 0F, 0F, -0.6F, -0.2F); // Box 0
		barrelModel[6].setRotationPoint(0F, -0.5F, 0F);

		barrelModel[7].addShapeBox(10.5F, -0.2F, -0.5F, 2, 1, 1, 0F,0F, -0.6F, -0.2F, 0F, -0.7F, 0F, 0F, -0.7F, 0F, 0F, -0.6F, -0.2F, 0F, -0.2F, -0.4F, 0F, 0F, -0.3F, 0F, 0F, -0.3F, 0F, -0.2F, -0.4F); // Box 0
		barrelModel[7].setRotationPoint(0F, -0.5F, 0F);

		barrelModel[8].addShapeBox(10.25F, 0.8F, -0.5F, 1, 1, 1, 0F,0F, 0F, -0.2F, 0F, 0F, -0.2F, 0F, 0F, -0.2F, 0F, 0F, -0.2F, 0F, -0.6F, -0.2F, 0F, -0.4F, -0.2F, 0F, -0.4F, -0.2F, 0F, -0.6F, -0.2F); // Box 0
		...
		barrelModel[10].addShapeBox(-9.5F, -1.5F, -1F, 6, 3, 2, 0F,0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 0
		...
		barrelModel[11].setRotationPoint(0F, -0.5F, 0F);
		...
		barrelModel[12].setRotationPoint(0F, -0.5F, 0F);

		barrelModel[13].addShapeBox(-8.5F, -2.2F, -0.5F, 1, 1, 1, 0F,0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -0.7F, 0F, 0F, -0.7F, 0F, 0F, -0.7F, 0F, 0F, -0.7F, 0F); // Box 0
		barrelModel[13].setRotationPoint(0F, -0.5F, 0F);

		barrelModel[14].addShapeBox(-8.5F, -2.5F, -0.5F, 1, 1, 1, 0F,-0.25F, 0.1F, 0F, -0.25F, 0.1F, 0F, -0.25F, 0.1F, -0.8F, -0.25F, 0.1F, -0.8F, 0F, -0.7F, 0F, 0F, -0.7F, 0F, 0F, -0.7F, -0.7F, 0F, -0.7F, -0.7F); // Box 0
		barrelModel[14].setRotationPoint(0F, -0.5F, 0F);

		barrelModel[15].addShapeBox(-8.5F, -2.5F, -0.5F, 1, 1, 1, 0F,-0.25F, 0.1F, -0.8F, -0.25F, 0.1F, -0.8F, -0.25F, 0.1F, 0F, -0.25F, 0.1F, 0F, 0F, -0.7F, -0.7F, 0F, -0.7F, -0.7F, 0F, -0.7F, 0F, 0F, -0.7F, 0F); // Box 0
		barrelModel[15].setRotationPoint(0F, -0.5F, 0F);

		barrelModel[16].addShapeBox(-10.5F, -1F, -0.5F, 1, 1, 1, 0F,0F, -0.5F, 0.25F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -0.5F, 0.25F, 0F, 0F, 0.25F, 0F, -0.5F, 0F, 0F, -0.5F, 0F, 0F, 0F, 0.25F); // Box 0
		barrelModel[16].setRotationPoint(0F, -0.5F, 0F);
		...
		barrelModel[17].setRotationPoint(0F, -0.5F, 0F);
		...
		barrelModel[18].setRotationPoint(0F, -0.5F, 0F);
		...
		barrelModel[19].setRotationPoint(0F, -0.5F, 0F);

		barrelModel[20].addShapeBox(-11.5F, -1F, 1F, 1, 3, 1, 0F,-0.7F, -0.2F, 0F, 0F, -0.2F, -0.2F, 0F, -0.2F, -0.2F, -0.7F, -0.2F, 0F, -0.7F, -0.2F, 0F, 0F, -0.2F, -0.2F, 0F, -0.2F, -0.2F, -0.7F, -0.2F, 0F); // Box 0
		barrelModel[20].setRotationPoint(0F, -1F, 0F);

		barrelModel[21].addShapeBox(-11.5F, -1F, 1F, 1, 1, 1, 0F,-0.3F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -0.3F, 0F, 0F, -0.3F, -0.8F, 0F, 0F, -0.8F, 0F, 0F, -0.8F, 0F, -0.3F, -0.8F, 0F); // Box 0
		barrelModel[21].setRotationPoint(0F, -1F, 0F);

		barrelModel[22].addShapeBox(-10.5F, -1F, 1F, 2, 1, 1, 0F,0F, 0F, 0F, 0F, 0F, 0F, -1F, 0F, 0F, 0F, 0F, 0F, 0F, -0.8F, 0F, 0F, -0.8F, 0F, -1F, -0.8F, 0F, 0F, -0.8F, 0F); // Box 0
		barrelModel[22].setRotationPoint(0F, -1F, 0F);

		barrelModel[23].addShapeBox(-10.5F, 1F, 1F, 2, 1, 1, 0F,0F, -0.8F, 0F, 0F, -0.8F, 0F, -1F, -0.8F, 0F, 0F, -0.8F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -1F, 0F, 0F, 0F, 0F, 0F); // Box 0
		barrelModel[23].setRotationPoint(0F, -1F, 0F);

		barrelModel[24].addShapeBox(-10.5F, 1F, -2F, 2, 1, 1, 0F,0F, -0.8F, 0F, -1F, -0.8F, 0F, 0F, -0.8F, 0F, 0F, -0.8F, 0F, 0F, 0F, 0F, -1F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 0
		barrelModel[24].setRotationPoint(0F, -1F, 0F);

		barrelModel[25].addShapeBox(-10.5F, -1F, -2F, 2, 1, 1, 0F,0F, 0F, 0F, -1F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -0.8F, 0F, -1F, -0.8F, 0F, 0F, -0.8F, 0F, 0F, -0.8F, 0F); // Box 0
		barrelModel[25].setRotationPoint(0F, -1F, 0F);

		barrelModel[26].addShapeBox(-11.5F, -1F, 1F, 1, 3, 1, 0F,0F, -0.2F, -0.2F, -0.7F, -0.2F, 0F, -0.7F, -0.2F, 0F, 0F, -0.2F, -0.2F, 0F, -0.2F, -0.2F, -0.7F, -0.2F, 0F, -0.7F, -0.2F, 0F, 0F, -0.2F, -0.2F); // Box 0
		barrelModel[26].setRotationPoint(0F, -1F, 0F);

		barrelModel[27].addShapeBox(-11.5F, -1F, 1F, 1, 3, 1, 0F,-0.3F, -0.2F, 0F, -0.3F, -0.2F, 0F, -0.3F, -0.2F, 0F, -0.3F, -0.2F, 0F, -0.3F, -0.2F, 0F, -0.3F, -0.2F, 0F, -0.3F, -0.2F, 0F, -0.3F, -0.2F, 0F); // Box 1
		barrelModel[27].setRotationPoint(0F, -1F, 0F);

		barrelModel[28].addShapeBox(-11.5F, -1F, 1F, 1, 1, 1, 0F,0F, 0F, -0.2F, -0.7F, 0F, 0F, -0.7F, 0F, 0F, 0F, 0F, -0.2F, 0F, -0.8F, -0.2F, -0.7F, -0.8F, 0F, -0.7F, -0.8F, 0F, 0F, -0.8F, -0.2F); // Box 2
		barrelModel[28].setRotationPoint(0F, -1F, 0F);

		barrelModel[29].addShapeBox(-11.5F, 1F, 1F, 1, 1, 1, 0F,-0.3F, -0.8F, 0F, 0F, -0.8F, 0F, 0F, -0.8F, 0F, -0.3F, -0.8F, 0F, -0.3F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -0.3F, 0F, 0F); // Box 3
		barrelModel[29].setRotationPoint(0F, -1F, 0F);

		barrelModel[30].addShapeBox(-11.5F, 1F, 1F, 1, 1, 1, 0F,0F, -0.8F, -0.2F, -0.7F, -0.8F, 0F, -0.7F, -0.8F, 0F, 0F, -0.8F, -0.2F, 0F, 0F, -0.2F, -0.7F, 0F, 0F, -0.7F, 0F, 0F, 0F, 0F, -0.2F); // Box 4
		barrelModel[30].setRotationPoint(0F, -1F, 0F);

		barrelModel[31].addShapeBox(-11.5F, 1F, -2F, 1, 1, 1, 0F,-0.3F, -0.8F, 0F, 0F, -0.8F, 0F, 0F, -0.8F, 0F, -0.3F, -0.8F, 0F, -0.3F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -0.3F, 0F, 0F); // Box 5
		barrelModel[31].setRotationPoint(0F, -1F, 0F);

		barrelModel[32].addShapeBox(-11.5F, 1F, -2F, 1, 1, 1, 0F,0F, -0.8F, -0.2F, -0.7F, -0.8F, 0F, -0.7F, -0.8F, 0F, 0F, -0.8F, -0.2F, 0F, 0F, -0.2F, -0.7F, 0F, 0F, -0.7F, 0F, 0F, 0F, 0F, -0.2F); // Box 6
		barrelModel[32].setRotationPoint(0F, -1F, 0F);

		barrelModel[33].addShapeBox(-11.5F, -1F, -2F, 1, 3, 1, 0F,0F, -0.2F, -0.2F, -0.7F, -0.2F, 0F, -0.7F, -0.2F, 0F, 0F, -0.2F, -0.2F, 0F, -0.2F, -0.2F, -0.7F, -0.2F, 0F, -0.7F, -0.2F, 0F, 0F, -0.2F, -0.2F); // Box 7
		barrelModel[33].setRotationPoint(0F, -1F, 0F);

		barrelModel[34].addShapeBox(-11.5F, -1F, -2F, 1, 3, 1, 0F,-0.3F, -0.2F, 0F, -0.3F, -0.2F, 0F, -0.3F, -0.2F, 0F, -0.3F, -0.2F, 0F, -0.3F, -0.2F, 0F, -0.3F, -0.2F, 0F, -0.3F, -0.2F, 0F, -0.3F, -0.2F, 0F); // Box 8
		barrelModel[34].setRotationPoint(0F, -1F, 0F);

		barrelModel[35].addShapeBox(-11.5F, -1F, -2F, 1, 3, 1, 0F,-0.7F, -0.2F, 0F, 0F, -0.2F, -0.2F, 0F, -0.2F, -0.2F, -0.7F, -0.2F, 0F, -0.7F, -0.2F, 0F, 0F, -0.2F, -0.2F, 0F, -0.2F, -0.2F, -0.7F, -0.2F, 0F); // Box 9
		barrelModel[35].setRotationPoint(0F, -1F, 0F);

		barrelModel[36].addShapeBox(-11.5F, -1F, -2F, 1, 1, 1, 0F,-0.3F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -0.3F, 0F, 0F, -0.3F, -0.8F, 0F, 0F, -0.8F, 0F, 0F, -0.8F, 0F, -0.3F, -0.8F, 0F); // Box 10
		barrelModel[36].setRotationPoint(0F, -1F, 0F);

		barrelModel[37].addShapeBox(-11.5F, -1F, -2F, 1, 1, 1, 0F,0F, 0F, -0.2F, -0.7F, 0F, 0F, -0.7F, 0F, 0F, 0F, 0F, -0.2F, 0F, -0.8F, -0.2F, -0.7F, -0.8F, 0F, -0.7F, -0.8F, 0F, 0F, -0.8F, -0.2F); // Box 11
		...
		barrelModel[38].setRotationPoint(0F, -1F, 0F);
		...
		barrelModel[39].setRotationPoint(0F, -1F, 0F);
		...
		barrelModel[40].setRotationPoint(0F, -1F, 0F);
		...
		barrelModel[41].setRotationPoint(0F, -1F, 0F);
		...
		barrelModel[42].setRotationPoint(0F, -1F, 0F);
		...
		barrelModel[43].setRotationPoint(0F, -1F, 0F);
		...
		barrelModel[44].setRotationPoint(0F, -1F, 0F);
		...
		barrelModel[45].setRotationPoint(0F, -1F, 0F);
		...
		barrelModel[47].addShapeBox(10.5F, -2F, -1.5F, 1, 1, 3, 0F,0.5F, -0.1F, -0.8F, 0F, -0.1F, -0.8F, 0F, -0.1F, -0.8F, 0.5F, -0.1F, -0.8F, 0.5F, -0.1F, 0F, 0F, -0.1F, 0F, 0F, -0.1F, 0F, 0.5F, -0.1F, 0F); // Box 1
		barrelModel[47].setRotationPoint(0F, -0.5F, 0F);

		barrelModel[48].addShapeBox(10.5F, -1F, -1.5F, 1, 1, 3, 0F,0.5F, 0.1F, 0F, 0F, 0.1F, 0F, 0F, 0.1F, 0F, 0.5F, 0.1F, 0F, 0.5F, 0.1F, 0F, 0F, 0.1F, 0F, 0F, 0.1F, 0F, 0.5F, 0.1F, 0F); // Box 2
		barrelModel[48].setRotationPoint(0F, -0.5F, 0F);

		barrelModel[49].addShapeBox(10.5F, 0F, -1.5F, 1, 1, 3, 0F,0.5F, -0.1F, 0F, 0F, -0.1F, 0F, 0F, -0.1F, 0F, 0.5F, -0.1F, 0F, 0.5F, -0.1F, -0.8F, 0F, -0.1F, -0.8F, 0F, -0.1F, -0.8F, 0.5F, -0.1F, -0.8F); // Box 3
		barrelModel[49].setRotationPoint(0F, -0.5F, 0F);

		barrelModel[50].addShapeBox(0.5F, -1F, -1.5F, 10, 1, 3, 0F,0F, -0.3F, 0F, -0.5F, -0.3F, 0F, -0.5F, -0.3F, 0F, 0F, -0.3F, 0F, 0F, -0.3F, 0F, -0.5F, -0.3F, 0F, -0.5F, -0.3F, 0F, 0F, -0.3F, 0F); // Box 4
		barrelModel[50].setRotationPoint(0F, -0.5F, 0F);

		barrelModel[51].addShapeBox(0.5F, -1.4F, -1.5F, 10, 1, 3, 0F,0F, -0.3F, -0.05F, -0.5F, -0.3F, -0.05F, -0.5F, -0.3F, -0.05F, 0F, -0.3F, -0.05F, 0F, -0.3F, -0.05F, -0.5F, -0.3F, -0.05F, -0.5F, -0.3F, -0.05F, 0F, -0.3F, -0.05F); // Box 5
		barrelModel[51].setRotationPoint(0F, -0.5F, 0F);

		barrelModel[52].addShapeBox(0.5F, -0.6F, -1.5F, 10, 1, 3, 0F,0F, -0.3F, -0.05F, -0.5F, -0.3F, -0.05F, -0.5F, -0.3F, -0.05F, 0F, -0.3F, -0.05F, 0F, -0.3F, -0.05F, -0.5F, -0.3F, -0.05F, -0.5F, -0.3F, -0.05F, 0F, -0.3F, -0.05F); // Box 6
		barrelModel[52].setRotationPoint(0F, -0.5F, 0F);

		barrelModel[53].addShapeBox(0.5F, -2F, -0.1F, 10, 3, 1, 0F,0F, -0.1F, -0.3F, -0.5F, -0.1F, -0.3F, -0.5F, -0.1F, -0.3F, 0F, -0.1F, -0.3F, 0F, -0.1F, -0.3F, -0.5F, -0.1F, -0.3F, -0.5F, -0.1F, -0.3F, 0F, -0.1F, -0.3F); // Box 7
		barrelModel[53].setRotationPoint(0F, -0.5F, 0F);

		barrelModel[54].addShapeBox(0.5F, -2F, -0.5F, 10, 3, 1, 0F,0F, -0.15F, -0.3F, -0.5F, -0.15F, -0.3F, -0.5F, -0.15F, -0.3F, 0F, -0.15F, -0.3F, 0F, -0.15F, -0.3F, -0.5F, -0.15F, -0.3F, -0.5F, -0.15F, -0.3F, 0F, -0.15F, -0.3F); // Box 9
		barrelModel[54].setRotationPoint(0F, -0.5F, 0F);

		barrelModel[55].addShapeBox(0.5F, -1F, -1.5F, 10, 1, 3, 0F,0F, -1.1F, 0F, -0.5F, -1.1F, 0F, -0.5F, 0.5F, -0.4F, 0F, 0.5F, -0.4F, 0F, 0.5F, -0.4F, -0.5F, 0.5F, -0.4F, -0.5F, -1.1F, 0F, 0F, -1.1F, 0F); // Box 13
		barrelModel[55].setRotationPoint(0F, -0.5F, 0F);

		barrelModel[56].addShapeBox(0.5F, -1F, -1.5F, 10, 1, 3, 0F,0F, 0.5F, -0.4F, -0.5F, 0.5F, -0.4F, -0.5F, -1.1F, 0F, 0F, -1.1F, 0F, 0F, -1.1F, 0F, -0.5F, -1.1F, 0F, -0.5F, 0.5F, -0.4F, 0F, 0.5F, -0.4F); // Box 14
		barrelModel[56].setRotationPoint(0F, -0.5F, 0F);

		barrelModel[57].addShapeBox(0.5F, -2F, -0.9F, 10, 3, 1, 0F,0F, -0.1F, -0.3F, -0.5F, -0.1F, -0.3F, -0.5F, -0.1F, -0.3F, 0F, -0.1F, -0.3F, 0F, -0.1F, -0.3F, -0.5F, -0.1F, -0.3F, -0.5F, -0.1F, -0.3F, 0F, -0.1F, -0.3F); // Box 16
		barrelModel[57].setRotationPoint(0F, -0.5F, 0F);

		barrelModel[58].addShapeBox(0.5F, -2F, -0.5F, 10, 3, 1, 0F,0F, -0.15F, -1.1F, -0.5F, -0.15F, -1.1F, -0.5F, -0.55F, 0.55F, 0F, -0.55F, 0.55F, 0F, -0.55F, 0.55F, -0.5F, -0.55F, 0.55F, -0.5F, -0.15F, -1.1F, 0F, -0.15F, -1.1F); // Box 17
		barrelModel[58].setRotationPoint(0F, -0.5F, 0F);

		barrelModel[59].addShapeBox(0.5F, -2F, -0.5F, 10, 3, 1, 0F,0F, -0.55F, 0.55F, -0.5F, -0.55F, 0.55F, -0.5F, -0.15F, -1.1F, 0F, -0.15F, -1.1F, 0F, -0.15F, -1.1F, -0.5F, -0.15F, -1.1F, -0.5F, -0.55F, 0.55F, 0F, -0.55F, 0.55F); // Box 18
		barrelModel[59].setRotationPoint(0F, -0.5F, 0F);

		barrelModel[60].addShapeBox(10.25F, -2.2F, -0.5F, 1, 1, 1, 0F,-0.1F, 0F, -0.1F, -0.1F, 0F, -0.1F, -0.1F, 0F, -0.1F, -0.1F, 0F, -0.1F, -0.1F, 0F, -0.1F, -0.1F, 0F, -0.1F, -0.1F, 0F, -0.1F, -0.1F, 0F, -0.1F); // Box 19
		barrelModel[60].setRotationPoint(0F, -0.5F, 0F);

		barrelModel[61].addShapeBox(10.25F, -3.2F, -0.5F, 1, 1, 1, 0F,-0.3F, -0.5F, -0.3F, -0.3F, -0.5F, -0.3F, -0.3F, -0.5F, -0.3F, -0.3F, -0.5F, -0.3F, -0.1F, 0F, -0.1F, -0.1F, 0F, -0.1F, -0.1F, 0F, -0.1F, -0.1F, 0F, -0.1F); // Box 20
		barrelModel[61].setRotationPoint(0F, -0.5F, 0F);

		barrelModel[62].addShapeBox(-9.5F, -2F, -0.5F, 6, 1, 1, 0F,-0.8F, 0F, -0.2F, -0.3F, 0F, -0.2F, -0.3F, 0F, -0.2F, -0.8F, 0F, -0.2F, -0.5F, -0.5F, -0.2F, 0F, -0.5F, -0.2F, 0F, -0.5F, -0.2F, -0.5F, -0.5F, -0.2F); // Box 21
		barrelModel[62].setRotationPoint(0F, -0.5F, 0F);
	}
}